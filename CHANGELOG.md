<a name="12.1.0"></a>
# 12.1.0 "iron-test" (2021-06-24)
### material
| Commit | Description |
| -- | -- |
| c05a07ed9 | fix(material): Focus indicators are now positioned (#19345) |
| fba22bc9d | fix(material): ng-add should always install matching CDK version (#18076) |
| a0113639b | fix(material): fix table generator schematic (#16204) |
### google-maps
| Commit | Description |
| -- | -- |
| c7565e26f | feat(google-maps): add visible input to marker (#22490) |
| 10ecfa0ec | feat(google-maps): add icon input to marker (#22357) |
| 952812090 | feat(google-maps): add clusterer click event (#22345) |
| 7c9b83a6f | fix(google-maps): ensure that a mapTypeId is always passed in (#22098) |
| 588a50650 | fix(google-maps): initialize directions service lazily (#22302) |
| 1fac4918e | fix(google-maps): instantiate geocoder lazily (#22159) |
| 3f1b1f79c | fix(google-maps): mapTypeId not being set from options (#21909) |
| b9a26a28f | fix(google-maps): correct minor typo in the code (#21915) |
| a4331ad99 | fix(google-maps): correct minor typo in the code (#21917) |
| cdb2326fd | feat(google-maps): support options object on marker clusterer (#21861) |
| 86251af44 | feat(google-maps): add geocoder wrapper (#21832) |
| 09581eedc | feat(google-maps): add heatmap support (#21489) |
| 9dbf49b66 | feat(google-maps): Add MapDirectionsRenderer and MapDirectionsService (#21736) |
| eee082dbe | fix(google-maps): compatibility with latest typings (#21441) |
| d21a78d0b | fix(google-maps): typo in retina methods (#21419) |
| 4a587a112 | fix(google-maps): server-side rendering error from map clusterer (#21049) |
| 4a6000555 | fix(google-maps): avoid using dotted property access (#21074) |
| 17c357f69 | fix(google-maps): info window not opening if no anchor is passed in (#21014) |
| fb59f7aec | feat(google-maps): Add MapMarkerClusterer Component (#20944) |
| f7023c8a3 | fix(google-maps): allow ground overlay bounds to be changed (#20873) |
| cc503c4e0 | fix(google-maps): maintain subscriptions across event targets (#20897) |
| f0a4e59fd | fix(google-maps): rendering blank if custom options with no zoom are provided (#20882) |
| 3345a9a39 | feat(google-maps): Add Layer components. (#19604) |
| 90f4d0e6a | fix(google-maps): avoid re-initializing info window for same marker (#19299) |
| 2b0072582 | feat(google-maps): Add KML Layer component to Google Maps (#19226) |
| 9ce2a9013 | fix(google-maps): rendering blank if custom options with no center are provided (#19916) |
| e32e2e220 | fix(google-maps): allow for dimensions to be controlled through CSS (#19790) |
| 6544de87a | fix(google-maps): add exportAs to all directives (#19522) |
| d0ab041b0 | fix(google-maps): allow different anchor objects for info window (#19378) |
| 485352e0f | fix(google-maps): allow for ground overlay image to be changed (#19306) |
| eba622a73 | feat(google-maps): add ground overlay component (#19143) |
| 28e680c5b | fix(google-maps): avoid runtime error on server |
| 3e00f4c5f | feat(google-maps): expose the underlying Google Maps objects. (#18613) |
| 23161d77a | fix(google-maps): not rendering until mapTypeId is set (#18967) |
| c71bbf27d | fix(google-maps): map circle error during server-side rendering (#18822) |
| 2a6aae179 | feat(google-maps): support setting the map type (#18578) |
| b2d08df8e | fix(google-maps): server-side rendering error for polygon and rectangle components (#18573) |
| 591ac9cdf | fix(google-maps): avoid errors when accessing API too early (#18376) |
| 3e2e0234e | fix(google-maps): internal events run inside NgZone (#18034) |
| 149669e6e | fix(google-maps): sub-components throwing during server-side rendering (#18059) |
| 02c24ec85 | fix(google-maps): support numbers for width/height of the map (#18105) |
| f2cbc066a | fix(google-maps): incorrect event name (#18027) |
| 22fecb356 | fix(google-maps): unable to subscribe to events after initialization (#17845) |
| 0c1082869 | feat(google-maps): Add MapPolyline component (#17512) |
| d990243b6 | fix(google-maps): handle trying to access the map before it has been initialized (#17805) |
| b2ea4c82c | fix(google-maps): avoid event listener leaks if inputs change (#17664) |
| 0b0e98c8b | fix(google-maps): error during server-side rendering (#17744) |
| ef8ba0d8b | fix(google-maps): Fix clickable input for MapMarker (#17396) |
| 9ee6b26fb | fix(google-maps): separate map input watchers (#17364) |
| 30de283ad | feat(google-maps): Add map-info-window component (#17027) |
| c8ceae5b2 | feat(google-maps): add map-marker component (#16964) |
| 94c71b03d | feat(google-maps): Add methods and event handling to Google Map (#16804) |
| a6d1445e9 | feat(google-maps): add input options for google Map component (#16759) |
| 6416babbb | feat(google-maps): add google-map component skeleton (#16623) |
### youtube-player
| Commit | Description |
| -- | -- |
| 0c83adc8f | fix(youtube-player): compatibility with latest typings (#22223) |
| b0d0388c1 | fix(youtube-player): YT.Player is not a constructor (#20616) |
| cc36af7d1 | feat(youtube-player): support passing in the playerVars parameter (#19746) |
| d85732ced | fix(youtube-player): binding some event listeners too late (#19429) |
| bac677547 | fix(youtube-player): unable to bind to events after initialization (#18996) |
| 0d108d3c8 | fix(youtube-player): handle API interactions before API has loaded (#18368) |
| 2c8dca897 | fix(youtube-player): memory leak if player is destroyed before it is done initializing (#18046) |
| 8f2007f78 | fix(youtube-player): not picking up static startSeconds and endSeconds (#18214) |
| 27fae2927 | fix(youtube-player): avoid setInterval change detection when player is created (#17894) |
| 7defaa692 | fix(youtube-player): avoid clobbering api loaded callback (#17850) |
| ab0f30df7 | fix(youtube-player): clean up internal observables (#17835) |
| 61b423a40 | perf(youtube-player): triggering change detection for unused events (#17665) |
| 59b0ee4f2 | fix(youtube-player): errors during server-side rendering (#17091) |
| 83545cfd5 | feat(youtube-player): add feature for waiting until the API has finished loading (#16998) |
| f02fb47f3 | feat(youtube-player): Add documentation README (#16925) |
| d5d7db4c8 | feat(youtube-player): add start/end seconds & suggested quality inputs (#16736) |
| a973b58ae | feat(youtube-player): Add proxy methods for calling the underlying player (#16735) |
| 8093b81e9 | feat(youtube-player): Add width and height as inputs (#16734) |
| 442f58053 | feat(youtube-player): Add outputs that are proxies from the embed API. (#16733) |
| b8c9da626 | feat(youtube-player): initialize component and infrastructure (#16337) |
### cdk-experimental
| Commit | Description |
| -- | -- |
| 3765433c5 | feat(cdk-experimental): expose root loader instance in testbed harness environment (#16903) |
### material-experimental
| Commit | Description |
| -- | -- |
| 1dee6b25b | feat(material-experimental): bump peer dependency to MDC v8.0.0 canary (#20527) |
| d1378481b | feat(material-experimental): MDC-based version of dialog |
| d1607cbb8 | feat(material-experimental): add MDC-based mat-option and mdc-core entry point (#19557) |
| 45492b655 | fix(material-experimental): strong focus indicator clipped in checkbox and radio button (#19423) |
| 5d25d1b23 | fix(material-experimental): better server-side rendering support for progress bar (#19036) |
| 3d351802c | fix(material-experimental): rename theme files to match stable components (#18383) |
| 9cfc66d5e | fix(material-experimental): icon/fab missing states color (#18403) |
| 3af0d8ac6 | fix(material-experimental): consolidate mixins in e2e theme file (#18385) |
| 1b167019a | fix(material-experimental): errors with latest MDC canary version (#18173) |
| 797b0fcf5 | fix(material-experimental): mdc-theming and mdc-typography files not published (#18251) |
| 697c3a0c4 | feat(material-experimental): initial prototype of mdc-form-fie… (#17903) |
| 7cd314c53 | feat(material-experimental): add test harness for mdc-slider (#16978) |
| f084f13ba | fix(material-experimental): use harnesses for mat-option (#17009) |
| 66c870820 | fix(material-experimental): throw better error when trying to use fixture after it has been destroyed (#17058) |
| 99e66b82d | fix(material-experimental): mdc-slider should not throw when rendering on the server (#16993) |
| 8f6171d0b | fix(material-experimental): mdc-typography should use default typography config |
| 0f0a71586 | fix(material-experimental): add mdc-slider to mdc-theming and mdc-typography (#16944) |
| f5e087b50 | feat(material-experimental): test harness for dialog (#16709) |
| 55e3d1e20 | feat(material-experimental): add autocomplete test harness (#16620) |
| ab9a847da | feat(material-experimental): add test harness for input (#16674) |
| 5194bea42 | fix(material-experimental): unit tests getting wrong root element and add API for getting property value (#16706) |
| dc2c700c6 | feat(material-experimental): option to filter tab-group harness by selected tab (#16813) |
| 89c784c6d | feat(material-experimental): add test harness for select (#16710) |
| e0d2ede4c | feat(material-experimental): add test harness for radio-group |
| 37086fd95 | feat(material-experimental): add test harness for tabs (#16728) |
| 0a16e0402 | feat(material-experimental): add test harness for slider (#16688) |
| 02a3f3e57 | feat(material-experimental): add sidenav test harness (#16695) |
| 3857ab262 | feat(material-experimental): add menu test harness skeleton (#16615) |
| 2cbabf06e | feat(material-experimental): add option to filter checkbox har… (#16662) |
| 92d95ef24 | fix(material-experimental): typo in harness focus methods (#16673) |
| 725a2b3c5 | feat(material-experimental): add progress spinner test harness… (#16622) |
| 808370e0a | feat(material-experimental): add progress bar test harness skeleton (#16619) |
| 88631b936 | feat(material-experimental): add test harness for button (#16556) |
| 2a04ccfd4 | feat(material-experimental): slide-toggle test harnesses (#16545) |
| 583af19e9 | feat(material-experimental): add test harness for radio-button (#16593) |
### 
| Commit | Description |
| -- | -- |
| f33210cfe | feat: add support for TypeScript 4.0 (#20368) |
| 79e4d283e | perf: allow assertions to be removed in production mode (#20146) |
| 5453d9149 | fix: remove element selectors from test harnesses (#20224) |
| 09e68db8e | fix: add non-null assertions for non-nullable input bindings (#20136) |
| 333e60999 | fix: tabindex inputs not supporting coercion (#20037) |
| df981eefd | fix: focus monitor-based styles not working in some cases inside shadow dom (#19422) |
| 6095e29f4 | feat: report warning if duplicate theme styles are generated |
| 400901b84 | fix: event emitter type (#18664) |
| 8ae7b18a9 | fix: consistently use const enum (#18390) |
| 05f59b36a | fix: reduce amount of generated high contrast styles (#18332) |
| 050ee7a40 | fix: responsiveness of autocomplete examples tab (#18007) |
| 2a2d8378c | fix: google-maps and youtube-player package missing tslib dependency (#17939) |
| 8da64f4db | feat: expand input types with coercion to work with ngtsc input type checking (#17528) |
| 41166b7d2 | feat: change tslib from direct dependency to peerDependency (#17393) |
| 473d4c6ad | feat: move clipboard module into cdk (#17272) |
| dd37ca574 | feat: Use en dash in MatPaginatorIntl (#16693) |
| fbf293a16 | fix: correct DevInfra alias (#16846) |
| 4c8956b2e | fix: update all files/directories owned by DevInfra to DevInfra alias (#16838) |
| 8ecfc7226 | fix: prevent default on escape key presses (#16202) |
| bb5d5440a | feat: run v8 migration schematics for v8 beta and rc releases (#15753) |
| 578790ba4 | fix: missing tag in footer-row of material table (#15711) |
| ae32092c2 | fix: error when attempting to access Intl API on some versions of Windows (#15693) |
| 20b140b24 | fix: add disabled styling for unchecked pseudo checkbox (#15405) |
| e739e61bc | fix: mark virtual scroll viewport queries as static (#15346) |
| 4cffc202a | fix: correct example title (#15325) |
| 8fc97acf4 | fix: add peer dependency on @angular/forms (#15133) |
| 35e89e534 | fix: errors when building theme using CSS variables (#15140) |
### Dialog
| Commit | Description |
| -- | -- |
| 3ee3ecb26 | feat(Dialog): don't override type attribute if set on mat-dialog-close (#16927) |
### MatPseudoCheckbox
| Commit | Description |
| -- | -- |
| bd37f8f2c | fix(MatPseudoCheckbox): fix checkmark pseudo-element box-sizing (#14971) |
### a11y
| Commit | Description |
| -- | -- |
| 544e33514 | feat(a11y): Add optional home/end key support to ListKeyManager (#19834) |
| 3fbebe02e | fix(a11y): list key manager not emitting change event if new item is added to active index (#19666) |
| 1acc608ed | fix(a11y): focus trap directive not capturing focus if auto capture input is set after init (#19689) |
| fe87bda34 | fix(a11y): focus monitor not checking children if monitor is called multiple times with different parameters (#19237) |
| 495edca34 | fix(a11y): focus monitor not working inside shadow dom (#19135) |
| 695dde64a | fix(a11y): focus monitor incorrectly detecting fake mousedown… (#15214) |
| 638320e08 | fix(a11y): avoid errors when trying to add high contrast class (#18323) |
| c704d17e6 | fix(a11y): focus trap incorrectly moving focus internally if focus was already moved into it (#18541) |
| 3673f3d30 | fix(a11y): focus monitor not identifying touch focus inside shadow root (#17167) |
| 8c4f25f34 | feat(a11y): allow for element to be used as message in AriaDescriber (#16118) |
| 1bc8bc4b9 | fix(a11y): don't set aria description if it's the same as the node's aria-label (#15250) |
| e2c987319 | feat(a11y): add injection token configure default politeness and duration (#15126) |
### aria-describer
| Commit | Description |
| -- | -- |
| 0e220192b | fix(aria-describer): messages not being read out in IE and Edge (#12304) |
### autocomplete
| Commit | Description |
| -- | -- |
| 2058f7166 | feat(autocomplete): support variable option height (#20324) |
| 1319c0a29 | fix(autocomplete): don't close when clicking inside custom origin (#19784) |
| 77699596a | fix(autocomplete): incorrectly detecting shadow DOM when inserted through an embedded view (#19332) |
| 619f7f8de | fix(autocomplete): provide horizontal fallback positions (#18906) |
| 4629e2338 | feat(autocomplete): add event when option is activated (#18387) |
| f0df3088a | fix(autocomplete): not picking up indirect descendant option g… (#17510) |
| f797cac91 | fix(autocomplete): top option group not scrolled into view when going up (#16343) |
| dec116b3f | feat(autocomplete): move harness out of experimental (#17080) |
| 6e1fe2cca | fix(autocomplete): unable to open panel via click inside shado… (#15616) |
| 4b8278633 | fix(autocomplete): alt + up arrow to close panel not working (#15364) |
| 121859283 | fix(autocomplete): not emitting opened event if options come in after open (#15582) |
| 5aaca5484 | feat(autocomplete): add input to control position (#15834) |
| 388baa249 | fix(autocomplete): make template ViewChild query `static: true` (#15877) |
| 413fe33c7 | fix(autocomplete): remove old classes when classlist has changed (#15185) |
| 40024703c | fix(autocomplete): set aria-haspopup (#15079) |
| 4913c36ea | fix(autocomplete): not updating origin if it changes after init (#14677) |
### autocomplete/testing
| Commit | Description |
| -- | -- |
| 4eef95874 | fix(autocomplete/testing): incorrect options if multiple panels are on the page at the same time (#19114) |
### autofill
| Commit | Description |
| -- | -- |
| 345cd8c7d | fix(autofill): use static queries to read values used in ngOnInit (#15516) |
### badge
| Commit | Description |
| -- | -- |
| 75f73aedb | fix(badge): allow more data types for badge content (#20331) |
| f96e820a8 | feat(badge): add test harness (#17661) |
| bdc681108 | fix(badge): throw proper error when set on a non-element node |
| 2b149526e | fix(badge): increase font size of small badge (#15280) |
| c5a32c214 | fix(badge): duplicate leftover badge after server-side render (#15417) |
| 4614fb8e5 | fix(badge): disable animations when using NoopAnimationsModule (#11408) |
### benchmark
| Commit | Description |
| -- | -- |
| 0d266e21d | fix(benchmark): fix license header and correct test descriptions (#19596) |
| 7d4fcd566 | fix(benchmark): fix license header, remove a11y import, and remove @title doc (#19582) |
### benchmarks
| Commit | Description |
| -- | -- |
| 74f622b0e | fix(benchmarks): add comments to make syncing into google3 easier (#19910) |
### bidi
| Commit | Description |
| -- | -- |
| 6ea0e96d2 | fix(bidi): handle uppercase values correctly (#14773) |
### bottom-sheet
| Commit | Description |
| -- | -- |
| 274416b6c | fix(bottom-sheet): allow result to be passed when dismissing through service (#18831) |
| a7c3ab0ac | feat(bottom-sheet): add test harness (#17618) |
| b622d1128 | fix(bottom-sheet): don't move focus if it was moved during close animation (#17725) |
| 77e47acc1 | fix(bottom-sheet): not moving focus to container if autoFocus is disabled and focus was moved while animating (#16418) |
| 3fb87d799 | fix(bottom-sheet): DOM nodes not cleaned up if view container is destroyed mid-animation (#16349) |
| 6b2a390e0 | feat(bottom-sheet): allow for scroll strategy to be configured (#15535) |
| 823d47156 | fix(bottom-sheet): unable to reopen same bottom sheet after closing via back button (#15520) |
| 378769571 | fix(bottom-sheet): focus trap not being attached when autoFocus is disabled (#15125) |
| 3d3179f2f | fix(bottom-sheet): allow disableClose to be updated after opened (#14711) |
### breakpoint-observer
| Commit | Description |
| -- | -- |
| bb66df77a | fix(breakpoint-observer): fix the breakpoint observer emit count and accuracy (#15964) |
### button
| Commit | Description |
| -- | -- |
| abfb7a293 | fix(button): don't use divs in button template (#20376) |
| 1c307c80a | fix(button): focus method does not respect specified origin (#17183) |
| 3dc33f1d6 | feat(button): move harness out of experimental (#17098) |
| 5fb0d577b | fix(button): fix typo in comment (#17001) |
| 9ca0f0c78 | fix(button): fix opacity is not added to ripple when using CSS variables to define custom theme |
| 664373541 | fix(button): ripples not being clipped to border radius on safari (#13645) |
| fda0c2d9f | fix(button): not updating DOM node name if group name changes (#14963) |
| fffbcb19e | fix(button): focus indication hard to see in high contrast mode (#13259) |
### button-toggle
| Commit | Description |
| -- | -- |
| b9756b998 | fix(button-toggle): clear static aria attributes from host nodes (#17086) |
| 85e8f3450 | fix(button-toggle): don't use divs inside button template (#20390) |
| c225b2894 | fix(button-toggle): remove unused property and type ToggleType (#19497) |
| 7f7e0a1ef | fix(button-toggle): static checked value not being picked up (#18442) |
| 9a6be0d24 | feat(button-toggle): add test harness (#17996) |
| 67b009f04 | fix(button-toggle): indirect descendant buttons not picked up… (#17451) |
| bd24369d3 | fix(button-toggle): error when check value is set via static attribute in Ivy (#16587) |
| a833dfb67 | fix(button-toggle): value cleared when replacing with list that still contains the selected value (#15508) |
| 623cd06cc | fix(button-toggle): clear name from host node (#15668) |
| 98f014245 | fix(button-toggle): remove references to selected toggle on destroy (#14627) |
### calendar
| Commit | Description |
| -- | -- |
| 679bdb660 | fix(calendar): should markForCheck when properties are changed (#15102) |
### card
| Commit | Description |
| -- | -- |
| 9b19e6a31 | fix(card): add missing card content selectors (#17488) |
| 399ed2939 | fix(card): stroked buttons missing margin (#16576) |
| 11a4ff0a6 | fix(card): disable all animations when using NoopAnimationsModule (#11538) |
### card/testing
| Commit | Description |
| -- | -- |
| 54c2d1676 | feat(card/testing): Add a test harness for `MatCard` (#19833) |
### cdk-experimental/clipboard
| Commit | Description |
| -- | -- |
| 17f25462b | fix(cdk-experimental/clipboard): avoid changing layout with temporary textarea (#17227) |
| eedf314ad | feat(cdk-experimental/clipboard): add better support for iOS devices, preliminary documentations (#16830) |
| 6fe8c06e9 | fix(cdk-experimental/clipboard): add missing tsconfig (#16785) |
### cdk-experimental/column-resize
| Commit | Description |
| -- | -- |
| 78fcea463 | fix(cdk-experimental/column-resize): not working inside OnPush component (#19671) |
### cdk-experimental/combobox
| Commit | Description |
| -- | -- |
| 6d1a25964 | fix(cdk-experimental/combobox): not cleaning up overlay on destroy (#20407) |
| 23d3c216c | feat(cdk-experimental/combobox): make CdkListbox compatible with CdkCombobox (#20291) |
| 809f1579e | feat(cdk-experimental/combobox): added additional open actions and a combobox-popup directive (#20306) |
| 618432885 | feat(cdk-experimental/combobox): add combobox base (#20211) |
| fbfe4cb0a | feat(cdk-experimental/combobox): created combobox file skeleton. |
### cdk-experimental/dialog
| Commit | Description |
| -- | -- |
| 2c59b424f | fix(cdk-experimental/dialog): disableClose not working for tem… (#18968) |
| 442ec3066 | fix(cdk-experimental/dialog): don't move focus if it was moved during close animation (#17320) |
| 70861fe8b | fix(cdk-experimental/dialog): re-export portal module (#14908) |
### cdk-experimental/listbox
| Commit | Description |
| -- | -- |
| 7c49399c4 | feat(cdk-experimental/listbox): multi-select and active descendant support (#19929) |
| 2a9741824 | feat(cdk-experimental/listbox): selection logic and testing for listbox. (#19690) |
| 042823109 | feat(cdk-experimental/listbox): add file skeleton (#19612) |
### cdk-experimental/menu
| Commit | Description |
| -- | -- |
| fb8721aed | feat(cdk-experimental/menu): add smart aim functionality to the menu (#20442) |
| de9846611 | feat(cdk-experimental/menu): add ability to open menus from a standalone trigger (#20363) |
| 69481861f | fix(cdk-experimental/menu): do not allow two separate triggers to open the same menu (#20300) |
| beaf07254 | fix(cdk-experimental/menu): ensure context menu is closed out with other menu elements on page (#20234) |
| 75042e47d | feat(cdk-experimental/menu): add roving tab index to menu items (#20235) |
| c7a7b1e5f | fix(cdk-experimental/menu): ensure menu is closed out when clicking on an inline menu item (#20241) |
| c0499b80b | fix(cdk-experimental/menu): fix double state toggle in radio and checkbox menu items (#20259) |
| 8b6808379 | feat(cdk-experimental/menu): add support for inline menus (#20143) |
| 0b5eaa8e4 | feat(cdk-experimental/menu): enable keyboard handling for context menu (#20171) |
| ecb6e3845 | fix(cdk-experimental/menu): re-open menu on hover after click to close on trigger (#20173) |
| d945b277c | feat(cdk-experimental/menu): add context menu trigger directive (#20144) |
| cdbf2c181 | feat(cdk-experimental/menu): add the ability to open/close menus on mouse click and hover (#20118) |
| 2980b077d | feat(cdk-experimental/menu): add ability to close menus when clicking outside the menu tree (#20064) |
| 7303780cc | fix(cdk-experimental/menu): fix bug preventing keyboard event handling if opened programmatically (#20004) |
| ffc6f4b65 | feat(cdk-experimental/menu): add functionality to navigate a Menu and MenuBar with a keyboard (#19962) |
| b3d6d92ea | feat(cdk-experimental/menu): implement menu handling logic (#19701) |
| 09b33c223 | fix(cdk-experimental/menu): Fix circular dependency |
| 7a4b453d3 | feat(cdk-experimental/menu): Implement grouping logic for menuitems |
| c7cadc35d | feat(cdk-experimental/menu): Add menu skeleton and build scripts (#19583) |
### cdk-experimental/selection
| Commit | Description |
| -- | -- |
| ebb39988e | feat(cdk-experimental/selection): Merge cdk–selection to the master (#20229) |
### cdk-experimental/table
| Commit | Description |
| -- | -- |
| 198911f5c | feat(cdk-experimental/table): experimental column resize (#16114) |
### cdk-experimental/table-scroll-container
| Commit | Description |
| -- | -- |
| deead4c69 | feat(cdk-experimental/table-scroll-container): Create directive and demo (#21200) |
### cdk-experimental/testing
| Commit | Description |
| -- | -- |
| fb5750b61 | feat(cdk-experimental/testing): allow restriction of parent element when using `locatorFor(harness)` (#16886) |
| 342c15e02 | feat(cdk-experimental/testing): Add a public stabilize method to TestElement (#16847) |
| 286038c4a | feat(cdk-experimental/testing): Improve keyboard event support in harnesses (#16645) |
| 6a7fc8156 | feat(cdk-experimental/testing): Adds a `HarnessPredicate` class (#16319) |
### cdk-stepper
| Commit | Description |
| -- | -- |
| e039d6388 | fix(cdk-stepper): coercing selectedIndex value to a Number (#14817) |
### cdk/a11y
| Commit | Description |
| -- | -- |
| 93499e95c | fix(cdk/a11y): Fix the touch/program origin regression introduced in the recent FocusMonitor refactor. (#22754) |
| f11775c66 | feat(cdk/a11y): Add a new InputModalityDetector service to detect the user's current input modality. (#22371) |
| 706fc485e | fix(cdk/a11y): not restoring focus to elements inside the shadow DOM (#22622) |
| a92ad3d0f | perf(cdk/a11y): only check for high contrast mode once (#22561) |
| 328c69416 | fix(cdk/a11y): prevent crashing Chrome tabs with hidden text (#22536) |
| 7718947db | fix(cdk/a11y): add ConfigurableFocusTrapConfig to the public API (#22138) |
| c0286ea50 | fix(cdk/a11y): FocusTrap deprecation docs don't render correctly (#22137) |
| c7edf03a0 | fix(cdk/a11y): detect fake touchstart events from screen readers (#21987) |
| d7db7c890 | feat(cdk/a11y): allow focus options to be passed in to focus trap (#21769) |
| f8df9f86d | fix(cdk/a11y): focusVia not accounting for focused child node (#21512) |
| 2e7407c0c | fix(cdk/a11y): set AriaDescriber messages container to visibility:hidden (#21186) |
| fec67cd9b | feat(cdk/a11y): support setting a role through AriaDescriber |
| c1ab0b803 | fix(cdk/a11y): allow for origin of already focused element to be changed (#20966) |
| 1ac653f7f | fix(cdk/a11y): cdkAriaLive default to polite (#20672) |
| 9edab81e6 | fix(cdk/a11y): error if FocusMonitor is used on non-element nodes (#20640) |
| 16a3730d1 | fix(cdk/a11y): add parent node check to AriaDescriber (#19951) |
| 35005f4da | fix(cdk/a11y): interactivity checker detecting tabbable state incorrectly for videos, audio and object elements |
| ea171358a | fix(cdk/a11y): make cdk-high-contrast work w/ emulated view encapsulation (#18152) |
| 6b7f091eb | feat(cdk/a11y): add high-contrast mode detection (#17378) |
| e66de463a | fix(cdk/a11y): remove aria-describedby attribute when no descriptions are left (#17074) |
### cdk/accordion
| Commit | Description |
| -- | -- |
| 76a09d975 | fix(cdk/accordion): enforce stricter types for inputs (#20287) |
| a41fb6e41 | fix(cdk/accordion): allow for closeAll to be used when multiple mode is disabled (#22055) |
### cdk/clipboard
| Commit | Description |
| -- | -- |
| 1f69ff4da | fix(cdk/clipboard): typo in injection token name (#21978) |
### cdk/coercion
| Commit | Description |
| -- | -- |
| a14eeb420 | feat(cdk/coercion): add coercion for string arrays (#20652) |
| cd968863c | fix(cdk/coercion): add the support for readonly array coercion (#18807) |
### cdk/collections
| Commit | Description |
| -- | -- |
| 42361c0b3 | fix(cdk/collections): recycle repeater strategy retaining references to destroyed views (#21744) |
| 3b3b55f13 | feat(cdk/collections): extract view repeater strategies from virtualForOf and CDK table. (#19964) |
### cdk/drag-drop
| Commit | Description |
| -- | -- |
| 1193972ca | fix(cdk/drag-drop): resolve various event tracking issues inside the shadow dom (#23026) |
| 0431d8152 | fix(cdk/drag-drop): error if dragged item is destroyed as a result of the `entered` event (#22904) |
| 7508f46e7 | fix(cdk/drag-drop): preserve initial transform inside drop list (#22422) |
| 1d906b64a | feat(cdk/drag-drop): added dropPoint to dropped event (#22347) |
| b92f97f55 | feat(cdk/drag-drop): allow for preview container to be customized (#21830) |
| 52aa21062 | fix(cdk/drag-drop): destroyed items not being cleaned up correctly (#21821) |
| 060ab9eb5 | fix(cdk/drag-drop): not blocking initial move event (#21752) |
| 92cb67e2a | fix(cdk/drag-drop): not detecting parent when projected using ngTemplateOutlet (#21668) |
| e65ead843 | feat(cdk/drag-drop): support configurable scroll speed (#21400) |
| eb318d938 | fix(cdk/drag-drop): don't block scrolling if it happens before delay has elapsed (#21382) |
| e42d502f8 | fix(cdk/drag-drop): don't stop event propagation unless nested (#21227) |
| 411b1747d | fix(cdk/drag-drop): account for enterPredicate when setting receiving class (#21346) |
| 5e5f87ac3 | fix(cdk/drag-drop): preview not inheriting styles inside shadow dom (#21107) |
| de5a940b0 | fix(cdk/drag-drop): avoid retaining disabled handles after they've been destroyed (#21015) |
| f13321022 | fix(cdk/drag-drop): don't disable native dragging on inactive handles (#20991) |
| 06294d1ca | fix(cdk/drag-drop): references to SVG not working inside preview (#20742) |
| 6d86f0f3c | fix(cdk/drag-drop): error if dragging starts from active sibling container (#20704) |
| 5eb10359d | fix(cdk/drag-drop): error when cloning file input with value (#20793) |
| d4b505a82 | fix(cdk/drag-drop): throw if drop list or handle are set on a non-element node (#20668) |
| 8c336c9cf | fix(cdk/drag-drop): preserve checked state for grouped radio inputs (#20237) |
| 78483bf46 | fix(cdk/drag-drop): pointer position calculation for SVG with viewBox (#19863) |
| e62e6bd4d | fix(cdk/drag-drop): dragging styles not reset once dragging is… (#17150) |
### cdk/layout
| Commit | Description |
| -- | -- |
| 16576e428 | fix(cdk/layout): decrease breakpoint upper bounds (#20866) |
| e3699dc3c | fix(cdk/layout): support readonly arrays for public methods (#20252) |
### cdk/observers
| Commit | Description |
| -- | -- |
| 015ac3f30 | fix(cdk/observers): incorrect coercion member type (#21116) |
### cdk/overlay
| Commit | Description |
| -- | -- |
| 3f26e99c8 | fix(cdk/overlay): expand test environment check (#22927) |
| 65358a9f6 | fix(cdk/overlay): not emitting for auxiliar button clicks (#22616) |
| efc0f9e70 | fix(cdk/overlay): resolve regression when overlay is imported through shorthand path (#22043) |
| 4b8427e2f | fix(cdk/overlay): not setting correct opacity in high contrast mode on Firefox (#21896) |
| 9e87050ea | fix(cdk/overlay): overriding pointer-events style (#21666) |
| 0c8cfa7c0 | fix(cdk/overlay): sub-pixel deviations throwing off positioning in some cases (#21427) |
| f940d344b | fix(cdk/overlay): block scroll strategy throwing off scroll behavior feature detection (#17223) |
| 57c7b6a08 | feat(cdk/overlay): connected-overlay directive should have input for disabling escape close (#20585) |
| 1d0e3c76f | fix(cdk/overlay): ensure error isn't thrown when many overlay items are closed from handler (#20377) |
| 7a63ad69c | fix(cdk/overlay): ensure OverlayOutsideClickDispatcher listens to contextmenu events (#20373) |
| d2b499da9 | fix(cdk/overlay): fix wrong overflow calculation (#17791) |
| 09f54767e | fix(cdk/overlay): support SVG element as overlay origin (#18595) |
| 73d1ceba4 | feat(cdk/overlay): accept PositionStrategy in cdkConnectedOverlay (#16374) |
| c69a727ac | fix(cdk/overlay): add missing transform origin directive input (#17489) |
### cdk/platform
| Commit | Description |
| -- | -- |
| 50b3207d1 | fix(cdk/platform): avoid error during server-side rendering if document is stubbed out (#22260) |
| 6fee2713c | fix(cdk/platform): adjust return type for _getShadowRoot (#21798) |
| 0ddad0777 | fix(cdk/platform): rtl scroll axis incorrectly determined in Safari macOS (#19830) |
### cdk/portal
| Commit | Description |
| -- | -- |
| 92af5f117 | fix(cdk/portal): not marked as attached when going through specific portal methods (#22372) |
### cdk/schematics
| Commit | Description |
| -- | -- |
| 805d3aef8 | fix(cdk/schematics): avoid runtime errors thrown by devkit tree (#22982) |
| 44cbab07e | fix(cdk/schematics): update generated css class (#22270) |
| b8b392375 | fix(cdk/schematics): fix resolving modules in ng update (#21161) |
| 00c5a539f | fix(cdk/schematics): errors when attempting to read some files (#19783) |
### cdk/scrolling
| Commit | Description |
| -- | -- |
| ddc2e23e8 | feat(cdk/scrolling): update ScrollDispatcher to allow HTMLElement parameters (#21201) |
| 390afca4b | fix(cdk/scrolling): Prevents NaN being returned as firstVisibleIndex. (#21505) |
| 43081d9d0 | fix(cdk/scrolling): virtual scroll not picking up trackBy function when items come in after init (#21335) |
| e15f82c25 | feat(cdk/scrolling): update CdkVirtualForOf to work with sets. (#20594) |
| 1d6ae5873 | fix(cdk/scrolling): fixed-size-virtual-scroll wrong range and position when items length changes and current scroll is greater than new data length (#19578) |
| 3e5e9db44 | fix(cdk/scrolling): expand type for "cdkVirtualForOf" input to… (#17421) |
### cdk/stepper
| Commit | Description |
| -- | -- |
| 5497be56d | fix(cdk/stepper): show error state if explicitly enabled (#22540) |
| 9b4c5035c | feat(cdk/stepper): emit event when the user interacts with a step (#22400) |
| 3a50c41c8 | feat(cdk/stepper): allow for orientation to be changed (#21940) |
| d3a271871 | fix(cdk/stepper): error if out-of-bounds index is assigned before initialization (#20766) |
### cdk/table
| Commit | Description |
| -- | -- |
| c42ece36d | feat(cdk/table): add element offsets to sticky styler state (#21886) |
| f68662cd5 | feat(cdk/table): add directive to enable recycle view repeater (#21508) |
| 155c7c2da | feat(cdk/table): add HTML elements to sticky styler update (#21704) |
| 764863278 | feat(cdk/table): Emit CSS classes on sticky elements that border non-sticky elements (#21179) |
| 58341a7cc | feat(cdk/table): add API for registering no data row (#20658) |
| 54c66bc87 | fix(cdk/table): add fallback code if view repeater isn't provided (#20604) |
| c77a9043f | fix(cdk/table): resolve breaking constructor changes (#20425) |
| 58e0c4875 | feat(cdk/table): fixed table layouts (#20258) |
| 5b23084ce | fix(cdk/table): project colgroup and col elements (#18135) |
### cdk/testing
| Commit | Description |
| -- | -- |
| 032feef08 | fix(cdk/testing): incorrectly handling ancestor of compound selector (#22476) |
| 58b4ab6d7 | fix(cdk/testing): prevent duplicate subscription (#22460) |
| 2f177b622 | fix(cdk/testing): unable to assign value to number inputs using sendKeys (#22395) |
| 91969f345 | feat(cdk/testing): create a webdriver harness environment (#22410) |
| e70e5dd30 | feat(cdk/testing): support modifiers for clicking on a TestElement (#20758) |
| 43997571d | perf(cdk/testing): reduce change detections when running parallel actions (#21071) |
| f99d0dd62 | feat(cdk/testing): allow for data to be attached to custom event (#20764) |
| b1be1646f | feat(cdk/testing): support right clicking on a TestElement (#20400) |
| 7d99c358a | fix(cdk/testing): avoid using dotted property access for dispatchEven… (#20754) |
| b7cfe6737 | feat(cdk/testing): add the ability to dispatch arbitrary events (#20714) |
| 8cacf645a | feat(cdk/testing): make MatButtonHarness extend ContentContainerComponentHarness (#20653) |
| 40fa9ffd9 | fix(cdk/testing): fix behavior in fakeAsync tests (#20638) |
| 5562788a2 | feat(cdk/testing): allow disabling & batching of change detection (#20464) |
| 5b725d68f | perf(cdk/testing): Improve performance of clicking in unit tests. (#20441) |
| 13284206b | feat(cdk/testing): add getNativeElement to harness environments (#20538) |
| 6de8ca3bc | feat(cdk/testing): add the ability to select options inside a native select |
| e01fac457 | fix(cdk/testing): fix change detection timing in testbed (#20465) |
| 8eb6754eb | feat(cdk/testing): add optional excludes to TestElement text method (#20145) |
| a5274a92d | fix(cdk/testing): emit pointer events on hover and mouseAway (#20098) |
| 6d2fb1fa5 | feat(cdk/testing): add base class for harnesses that may contain other harnesses (#19944) |
| a9ca95e4c | fix(cdk/testing): Make harnesses click on the center of the element by default (#19212) |
| 40ae1b100 | feat(cdk/testing): Allow custom `querySelectorAll` method (#18178) |
| 427e91fbf | fix(cdk/testing): don't send unnecessary `Key.chord`s to protr… (#18685) |
| e70499687 | feat(cdk/testing): add `isFocused` method to `TestElement` (#18183) |
| 15a5171de | feat(cdk/testing): support querying for multiple TestHarness /… (#17658) |
| c50aa21df | feat(cdk/testing): add method to wait for async tasks outside… (#17408) |
| bacdc8554 | feat(cdk/testing): move harness code from cdk-experimental (#17026) |
| 2d976a924 | feat(cdk/testing): allow `preventDefault` on mouse events (#16839) |
### cdk/testing/testbed
| Commit | Description |
| -- | -- |
| 94571c5aa | fix(cdk/testing/testbed): set defined event properties as configurable |
| bde3af875 | fix(cdk/testing/testbed): synthetic DOM events cannot be prevented multiple times |
| 9cd18911d | feat(cdk/testing/testbed): emit pointer events for test element click |
### cdk/text-field
| Commit | Description |
| -- | -- |
| 2427abe09 | fix(cdk/text-field): autosize text areas using the placeholder (#22314) |
| 476a90b08 | fix(cdk/text-field): autosize text areas using the placeholder (#22197) |
| 4b329f089 | fix(cdk/text-field): fix autofill listener on Chrome 80 (#18468) |
### cdk/tree
| Commit | Description |
| -- | -- |
| 22d5600aa | fix(cdk/tree): add missing generic types to trackBy Fixes (#21364) (#21421) |
| 1672b5163 | fix(cdk/tree): remove FocusMonitor from CdkTreeModule providers (#20493) |
| f951bf405 | fix(cdk/tree): fix level for nested tree nodes (#20226) |
| a45efb861 | fix(cdk/tree): remove CdkTreeNodeDef from CdkTreeModules providers (#20491) |
| e2c7e1ab8 | feat(cdk/tree): add trackBy to NestedTreeControl (#19602) |
| 04d158816 | feat(cdk/tree): support optional trackBy in FlatTreeControl (#18708) |
### cdk/virtual-scroll
| Commit | Description |
| -- | -- |
| d908c9f63 | fix(cdk/virtual-scroll): run changeDetection after computing transform (#17727) |
| b796b6eef | fix(cdk/virtual-scroll): fix subpixel rounding errors on hdpi… (#16269) |
### checkbox
| Commit | Description |
| -- | -- |
| 64145fd60 | fix(checkbox): not handling unknown color palette (#18467) |
| a95da9264 | fix(checkbox): high contrast focus indication not working (#19488) |
| e1d85d2bc | fix(checkbox): pass aria-describedby through to input (#19495) |
| d9cf17534 | fix(checkbox): outline not visible when checked in high contrast mode (#18048) |
| 227c49040 | fix(checkbox): unknown property warning with Ivy during server-side rendering (#17485) |
| 3fdab10bd | feat(checkbox): add options defaults config (#17473) |
| 09ded0430 | feat(checkbox): move checkbox harness out of experimental (#17067) |
| 60c9ebc37 | fix(checkbox): hover indication showing when disabled (#16159) |
| b4a9c627b | fix(checkbox): incorrect ripple color when unchecked (#13569) |
| 43b4fecd0 | fix(checkbox): don't show hover ripples on touch devices (#13700) |
| 20c27c7fb | fix(checkbox): unable to click to select if text is marked (#15062) |
| 01af4db01 | fix(checkbox): not marked as touched immediately on blur with OnPush change detection (#15001) |
### chips
| Commit | Description |
| -- | -- |
| 134cbf3d5 | fix(chips): support readonly collections in inputs (#20292) |
| 165622ee1 | feat(chips): add test harness (#20028) |
| 9be515627 | fix(chips): chip list overriding chip disabled value (#19228) |
| c67337b71 | fix(chips): chip list disabled state out of sync when swapping out form group with a disabled one (#17993) |
| 9badc54cc | fix(chips): only add type attribute to button remove icons (#18477) |
| bbb92a7e2 | fix(chips): unable to set custom tabindex on chip (#17699) |
| 8d57d3249 | fix(chips): set aria-required on chip input (#18098) |
| 3b4e4963a | fix(chips): avoid accidental form submits when pressing remove… (#18095) |
| 26e73ac3c | fix(chips): clear user agent styles when set on button (#17871) |
| 1923f7f95 | fix(chips): handle ripple color in theme using CSS variables (#17649) |
| 939c18df0 | fix(chips): don't set aria-required when element doesn't have… (#17425) |
| 57998a2e5 | fix(chips): allow null to be set as chip value (#16950) |
| aad7ff738 | fix(chips): preselected chip not highlighted on init inside OnPush component (#16868) |
| 86c626a6b | fix(chips): disable all animations when using NoopAnimationsModule (#11546) |
| 7f1223504 | fix(chips): chip-list doesn't pick up wrapped chips with ivy |
| 20a09301e | fix(chips): able to remove disabled chip via remove button (#15732) |
| e4881521d | fix(chips): unable to tab out of chip list with input on firefox (#15060) |
| 5fb61251b | fix(chips): focus lost if last chip is deleted (#15344) |
| 80538ef0d | fix(chips): remove aria-selected from deselected chip in single selection mode (#15634) |
| 0abc7122d | fix(chips): newly-added chips not being disabled when added to a disable list (#14976) |
### chips/testing
| Commit | Description |
| -- | -- |
| 20b4bc9c5 | fix(chips/testing): exclude icons from getText result (#20508) |
### clipboard
| Commit | Description |
| -- | -- |
| a6f1a3399 | fix(clipboard): scroll position changing while copying on some browsers (#20073) |
| ddc9fd6ba | fix(clipboard): not restoring focus to SVG elements (#18626) |
| 9227c7b83 | fix(clipboard): leak if directive is destroyed while a copy is pending (#18066) |
| a67cef6cf | feat(clipboard): add the ability to specify number of attempts in clipboard directive (#17547) |
| 1a2befa1e | fix(clipboard): namespace copied output name (#17598) |
| a8e0b4885 | feat(clipboard): add cdk-experimental clipboard service + directive (#16704) |
### column-resize
| Commit | Description |
| -- | -- |
| 3ce445264 | perf(column-resize): Further defer initial min/max column size application to reduce layout thrashing (#20238) |
| e2bc08307 | perf(column-resize): Coalesce style updates along with sticky styler (#20086) |
| 4ad33e82d | fix(column-resize): Unbreak Sass build by importing duplicate styles file (#19404) |
| 781051b8a | fix(column-resize): Resize table as well as columns, improve handing … (#19264) |
| c538354f7 | fix(column-resize): don't allow dragging using the right mouse… (#18758) |
### combobox
| Commit | Description |
| -- | -- |
| f7188211a | feat(combobox): add to dev-app (#20276) |
### common
| Commit | Description |
| -- | -- |
| ffad004cc | feat(common): Add dev-mode sanity check for mismatched versions of cdk and material (#15395) |
### components-examples
| Commit | Description |
| -- | -- |
| d12969265 | fix(components-examples): rename example component to follow naming convention for autoloading in docs (#19142) |
### core
| Commit | Description |
| -- | -- |
| c4b760483 | fix(core): allow for default color and tabindex to be set per instance (#20125) |
| a5b29c582 | fix(core): ripple mutating global options when animations are… (#18983) |
| 0ec499d7d | feat(core): add test harnesses for mat-option and mat-optgroup (#17940) |
| 77994e9de | feat(core): allow more granular control over sanity checks (#16973) |
### datepicker
| Commit | Description |
| -- | -- |
| dfdf5cf75 | feat(datepicker): add viewChanged output to calendar (#13759) (#20468) |
| 50eca15c1 | fix(datepicker): remove red shadow from invalid range inputs in Firefox (#20489) |
| 6296da29d | fix(datepicker): don't revalidate if new date object for same date is passed through input (#20362) |
| 2683b3dae | fix(datepicker): support dateClass on year and multi-year views (#20256) |
| 490a8939f | fix(datepicker): add coercion for opened input (#20250) |
| 984ca880b | fix(datepicker): range selection strategy not picking up custom date adapter (#19914) |
| 0433cd9e5 | fix(datepicker): not showing single-day comparison ranges (#20102) |
| af6b538c9 | fix(datepicker): not updating calendar state if input changes while open (#19973) |
| dc245d206 | fix(datepicker): emitting dateChange event when opposite range input changes (#19995) |
| 37e21710f | fix(datepicker): don't set aria-labelledby if form field does not have a label (#19639) |
| 9af441dc6 | fix(datepicker): range input separator not hidden in high contrast mode (#19706) |
| cfe37d18a | fix(datepicker): add role to date range input (#19717) |
| 8934feb8c | fix(datepicker): not marking as dirty when invalid value is typed in (#19730) |
| fcfc224c8 | fix(datepicker): label state not being updated in some cases (#19761) |
| 33aeea9a9 | fix(datepicker): not revalidating after value is changed through the calendar (#19695) |
| f428c0046 | fix(datepicker): date range overriding model value if both fields are changed at the same time (#19593) |
| ec7219dc7 | fix(datepicker): placeholder not behaving correctly in legacy form field (#19595) |
| 00e2171b2 | fix(datepicker): compilation errors with ViewEngine (#19516) |
| 2f8b271e0 | fix(datepicker): set color on range separator (#19308) |
| 4eee81a88 | fix(datepicker): strong focus indication in calendar always shown (#19304) |
| ec5f74c32 | fix(datepicker): double role definition on calendar cell (#17297) |
| 96efaad1b | feat(datepicker): add date range picker (#19125) |
| 9104a0b2e | feat(datepicker): allow for the dropdown position to be customized (#16698) |
| bb30a3a30 | fix(datepicker): inconsistent focus restoration timing in touchUi mode (#17732) |
| 049a11b52 | fix(datepicker): add hover indication to navigation buttons (#18995) |
| a7ebc7a84 | fix(datepicker): error in IE/Edge for static disabled binding (#18202) |
| 124ea5aa0 | fix(datepicker): disable calendar hover styles on touch devices (#18876) |
| aca253350 | fix(datepicker): prevent default dialog options from affecting… (#18657) |
| 5e34de2fd | fix(datepicker): don't call date filter function if date is out of bounds (#18419) |
| 321d3f92d | fix(datepicker): able to focus disabled datepicker toggle while disabled via click (#18231) |
| 5fe233add | fix(datepicker): memory leak in popup mode (#18102) |
| be17c2574 | fix(datepicker): re-render calendar when locale changes (#18094) |
| 61029c827 | fix(datepicker): not respecting form control updateOn: blur fo… (#18063) |
| ae28fce1f | fix(datepicker): year not formatted in multi-year view button (#17202) |
| b0c69dd90 | fix(datepicker): add scope to calendar headers (#17163) |
| 1b7dc8935 | fix(datepicker): don't set aria-haspopup if no datepicker is set (#15554) |
| f28a294de | feat(datepicker): align multi-year-view based on minDate and maxDate (#16018) |
| 0c6279829 | fix(datepicker): use narrower value for aria-haspopup (#15666) |
| c0399873e | fix(datepicker): add focus indication in high contrast mode (#15661) |
| 4a2d4efa5 | fix(datepicker): screen reader reading out role twice (#15663) |
| 1c503ff70 | fix(datepicker): toggle throwing an error if datepicker is not defined on init (#15256) |
| 5aefe6018 | fix(datepicker): update validation when switching from null to error input (#14423) |
### datepicker/testing
| Commit | Description |
| -- | -- |
| 90d6b70d8 | feat(datepicker/testing): add test harnesses for the datepicker module (#20219) |
### dialog
| Commit | Description |
| -- | -- |
| 199f72803 | fix(dialog): backdrop not detaching if container view is destroyed (#20232) |
| cf9bb1f56 | fix(dialog): restore focus with the proper focus origin (#9257) |
| 72b0219fb | fix(dialog): focus recapturing not accounting for autoFocus option (#19356) |
| 5bb81e84b | fix(dialog): focus trap not attached if autoFocus is disabled (#19251) |
| b612fc428 | fix(dialog): incorrect dialog state for close animation (#19034) |
| db873ea9a | fix(dialog): recapture focus when clicking on backdrop when cl… (#18826) |
| 656c6819a | fix(dialog): use view container from config when attaching content (#17819) |
| 3476f51da | fix(dialog): don't move focus if it was moved during close ani… (#17300) |
| 8859dfc13 | feat(dialog): move test harness out of experimental (#17104) |
| 3f0268ffe | feat(dialog): expose current dialog state (#16691) |
| 66fa26f17 | fix(dialog): not applying margins to new button variants (#11961) |
| 565bd7da6 | feat(dialog): allow for custom ComponentFactoryResolver to be passed in (#16437) |
| 0ed9416ab | fix(dialog): don't move focus to dialog container if focus is already inside the dialog (#16297) |
| 2ab867332 | fix(dialog): DOM nodes not cleaned up if view container is destroyed mid-animation (#16309) |
| 2e047b487 | fix(dialog): not moving focus to container if autoFocus is disabled and focus was moved from a different component (#16221) |
| c3ead653d | fix(dialog): remove default aria-label from mat-dialog-close (#15654) |
| 3163cc6d7 | fix(dialog): don't assign aria-label to close button if button has text (#11093) |
| 3e935e9b7 | feat(dialog): add ariaLabelledBy config option (#14943) |
| b62f3f3b4 | feat(dialog): support adding and removing classes via dialogRef (#14772) |
### document-injection
| Commit | Description |
| -- | -- |
| 204db567c | fix(document-injection): Update to use injected document (#18780) |
### drag-drop
| Commit | Description |
| -- | -- |
| d14d9861d | feat(drag-drop): add predicate function for whether an item can be sorted into an index (#20389) |
| 2b1d84e2b | perf(drag-drop): bind fewer touchmove listeners (#20404) |
| f795b9d8c | fix(drag-drop): expose some missing injection tokens (#20410) |
| fc67ff36c | fix(drag-drop): remove redundant style changes from handle directive (#20330) |
| 89b5fa89d | fix(drag-drop): warn if connected container ID doesn't exist (#20057) |
| d53d5b62d | fix(drag-drop): not transferring input value when cloning element for preview (#20009) |
| 2335571cc | fix(drag-drop): allow handle to be set on drag element if there is a different drag root (#19559) |
| 39d48c74b | fix(drag-drop): not starting auto scroll when inside boundary (#19865) |
| bc88cc1bb | fix(drag-drop): placeholder element not available in started event (#19493) |
| 0a6e4d6f8 | fix(drag-drop): sometimes incorrectly swapping items at the ends of the list (#19633) |
| 9d903e0dc | fix(drag-drop): update free drag position on scroll (#19648) |
| 3614a0b48 | fix(drag-drop): error when cloning 0x0 canvas (#19707) |
| fbd644075 | fix(drag-drop): error when item enters from the top and last has an intermediate child (#19361) |
| d309ee225 | fix(drag-drop): error during device emulation on firefox (#19396) |
| 58b8d30ef | fix(drag-drop): drop-list wrong enter position (#19116) |
| 0bf1a0784 | fix(drag-drop): boundary not accounting for parent scrolling (#19108) |
| 4431442d7 | fix(drag-drop): expose Point interface (#19051) |
| 7e660371d | fix(drag-drop): unable to start dragging in list if dragged item is destroyed (#19055) |
| cd7597925 | fix(drag-drop): preview matchSize sometimes incorrect inside flex container (#19062) |
| 9a0fba5ee | fix(drag-drop): boundary not accounting for scrolling (#18612) |
| 8a7128847 | fix(drag-drop): handle custom preview/placeholder with multiple root nodes (#18829) |
| 24a7c6dc9 | perf(drag-drop): avoid unnecessary change detection on pointer down events (#18821) |
| 4e02a95b9 | fix(drag-drop): allow preview z-index to be changed (#18914) |
| 3e984c77f | fix(drag-drop): defer resolving scrollable parents until first drag (#18918) |
| 531ea7cc5 | fix(drag-drop): error on IE when document is being auto scrolled (#18757) |
| 1a3c35a8c | fix(drag-drop): only return item to initial index if the new container's sorting is disabled (#18706) |
| e87de133e | fix(drag-drop): detect changes on custom preview/placeholder before measuring (#18698) |
| 74b344106 | feat(drag-drop): add option to match size of dragged element in custom preview (#18362) |
| d1a6ea74d | fix(drag-drop): not working correctly inside transplanted views (#18499) |
| f2f78a0f1 | fix(drag-drop): error when dragging items inside transplanted… (#18356) |
| 0760454ae | fix(drag-drop): not picking up initial disabled state of handle (#16643) |
| d05c69569 | fix(drag-drop): error if next sibling is removed after drag sequence has started (#18230) |
| 9459f5bd5 | fix(drag-drop): auto scrolling not working if list uses scroll snapping (#18294) |
| 4667cd4ab | feat(drag-drop): add injection token for configuring the input defaults (#17970) |
| c3194314f | feat(drag-drop): support scrolling parent elements apart from list and viewport (#18082) |
| a949db30c | fix(drag-drop): prevent dragging selected text with the mouse (#18103) |
| f80090028 | fix(drag-drop): position reset if viewport is resized while boundary is invisible (#17777) |
| ec7751343 | fix(drag-drop): disabled state not synced on data binding changes (#17330) |
| e2de5e6d3 | fix(drag-drop): coerce drop list autoScrollDisabled input (#17480) |
| ef9209121 | fix(drag-drop): not picking up indirect descendant items (#17226) |
| 34e848f36 | feat(drag-drop): allow for custom class to be set on preview (#17304) |
| f10b22268 | fix(drag-drop): global resize subscription not cleared (#17257) |
| 593a06cbb | fix(drag-drop): unable to drop into connected list inside shad… (#17424) |
| 43c7a7df1 | feat(drag-drop): allow drag start delay to be configured based… (#17301) |
| 9fe32c08a | fix(drag-drop): only call enterPredicate when pointer is inside drop list (#17310) |
| 2c1c30a25 | fix(drag-drop): unable to drop into connected sibling after scrolling into view via the parent (#17162) |
| 8a4bed544 | fix(drag-drop): error if custom preview or placeholder node is not an element (#16409) |
| 46cf45f48 | fix(drag-drop): preview position relative to cursor thrown off if item has margin (#16180) |
| 6009211c0 | fix(drag-drop): connected drop zones not working inside shadow root (#16899) |
| 306e07cba | fix(drag-drop): drop list ref sorting disabled by default (#16963) |
| 44b8a47b4 | fix(drag-drop): handle the element going out of the boundary after a viewport resize (#16874) |
| cad0102b3 | fix(drag-drop): incorrectly constraining element position if size changes between drag sequences (#16876) |
| 792e886d1 | fix(drag-drop): handle list and viewport auto scroll regions overlapping (#16675) |
| dd590441c | fix(drag-drop): unable to drop into connected sibling that was scrolled into view (#16681) |
| 738f10c99 | fix(drag-drop): fix drag start delay behavior to allow scrolling (#16228) |
| 154039188 | fix(drag-drop): return up-to-date position if getFreeDragPosition is called while dragging (#16464) |
| 207dba653 | feat(drag-drop): add support for automatic scrolling (#16382) |
| b15a7ecab | perf(drag-drop): use narrower check for touch events (#16082) |
| aadfc881b | fix(drag-drop): error if drag sequence is started while another one is finishing (#16081) |
| 35a045c5f | feat(drag-drop): include dragged distance in events (#15947) |
| e630bd6d8 | fix(drag-drop): allow for element in DropListRef to be changed (#15091) |
| 1ac938623 | fix(drag-drop): don't allow user to move item into container that isn't connected to current one by passing it over an intermediate one that is (#15660) |
| 31e72a730 | fix(drag-drop): preview element not maintaining canvas data (#15808) |
| 399f25eed | feat(drag-drop): allow element to be passed in as the boundary (#15810) |
| a6320672f | fix(drag-drop): error if item is removed while dragging (#15950) |
| 021b85a56 | fix(drag-drop): not reacting to changes in the cdkDragFreeDragPosition (#15805) |
| 2f009d00d | feat(drag-drop): add API to get/set current position of a standalone draggable (#14696) |
| 8bbb116e7 | fix(drag-drop): handle delay coming in as a string (#15425) |
| 9bbbb804d | fix(drag-drop): dragged styling not being removed when exiting component with OnPush (#15266) |
| 4704653ca | feat(drag-drop): add the ability to customize how the position is constrained (#15137) |
| 751fe8a0b | fix(drag-drop): clear duplicate ids from descendants (#15135) |
| f1e1528e8 | fix(drag-drop): preview not being rendered inside fullscreen element (#15066) |
| 1aafdbe6d | fix(drag-drop): disabled value not being synced to drop list ref (#15065) |
| 629460f1f | feat(drag-drop): add the ability to disable sorting in a list (#15064) |
| bcf278179 | feat(drag-drop): allow for dragging sequence to be delayed (#14732) |
| 8ddcb5ba2 | fix(drag-drop): standalone draggable drag class not being applied with OnPush change detection (#14727) |
| 456a0893d | fix(drag-drop): set class when item or list is disabled (#14769) |
| 5a18ea61e | feat(drag-drop): add service for attaching drag&drop to arbitrary DOM nodes (#14437) |
| 0bd93dd64 | fix(drag-drop): unable to move item into connected container by passing through another container (#14651) |
| 3656a4e30 | fix(drag-drop): incorrectly preserving transform if root element changes (#14697) |
| 005fb46ff | fix(drag-drop): restore initial transform when resetting (#14701) |
| 349675a18 | fix(drag-drop): apply translation transform before user transforms (#14712) |
| 1d4bb18da | fix(drag-drop): dragging styling not being reset in some cases with OnPush change detection (#14725) |
### drag-n-drop
| Commit | Description |
| -- | -- |
| 3b1ae0591 | fix(drag-n-drop): ignore consecutive touchmove events on drag item on multitouch (#15923) |
### examples
| Commit | Description |
| -- | -- |
| 83135e1c6 | fix(examples): fix form-field-custom-control (#15147) |
| 17fcb373e | fix(examples): fix form-field custom control `disabled` input (#14957) |
### expansion
| Commit | Description |
| -- | -- |
| 189d98e8b | fix(expansion): disable header height transition if noop animations is set (#19373) |
| f405cb6cb | fix(expansion): add strong focus indication (#18552) |
| 3a6c16f0c | fix(expansion): unable to toggle disabled panel via methods (#18181) |
| 6c4122c46 | fix(expansion): accordion picking up headers from descendant accordion during keyboard navigation (#17481) |
| 7bf5e4e0a | fix(expansion): show header focus state when expanded (#16486) |
| 6a21d947f | fix(expansion): not adding margin for all button types (#16806) |
| 98a231da4 | fix(expansion): incorrect margin for "before" indicator when expanded (#16420) |
| c3eac1759 | feat(expansion): allow expansion toggle indicator positioning (#16257) |
### expansion-panel
| Commit | Description |
| -- | -- |
| b0d1bada8 | fix(expansion-panel): header animating on init when using non-default height (#16122) |
| 779430429 | fix(expansion-panel): don't handle events with modifier keys in accordion (#15750) |
### experimental/dialog
| Commit | Description |
| -- | -- |
| ea31bca2c | fix(experimental/dialog): not moving focus to container if autoFocus is disabled and focus was moved while animating (#16446) |
| 7a04788cd | fix(experimental/dialog): set aria-modal on dialog container (#16323) |
### focus indicators
| Commit | Description |
| -- | -- |
| 3d03bf377 | fix(focus indicators): Improve styles that determine when focus indicators should render on selection controls. (#19546) |
### focus-monitor
| Commit | Description |
| -- | -- |
| a85b63c19 | perf(focus-monitor): optimize event registration (#18667) |
| b3a2c5614 | feat(focus-monitor): Add eventual detection mode option to foc… (#18684) |
| 085bbb78b | perf(focus-monitor): avoid triggering change detection if there are no subscribers to stream (#14964) |
### focus-trap
| Commit | Description |
| -- | -- |
| f66302d44 | fix(focus-trap): apply aria-hidden to focus trap tab anchors (#14644) |
### form-field
| Commit | Description |
| -- | -- |
| 7a2a7327a | fix(form-field): add a type check for userAriaDescribedBy |
| 23818f544 | feat(form-field): expose label content element id for custom controls (#18528) |
| 28f8edfd1 | fix(form-field): fix form-field comment for google sync (#20109) |
| e1bfb927d | fix(form-field): error in older versions of edge (#19698) |
| ba521d23a | fix(form-field): add missing material common module (#19093) |
| e311791bc | fix(form-field): some input types taller than plain text input (#18825) |
| 6275339f0 | fix(form-field): incorrectly calculating start gap in RTL in the presence of a prefix (#18867) |
| 8ec44a10a | feat(form-field): use injection token for providing form-field (#18777) |
| eb92de811 | fix(form-field): error when trying to lock label into position too early (#18666) |
| 52fea0662 | fix(form-field): fix underline jank in fill variant (#18407) |
| f573072b8 | fix(form-field): error when focusing outline form field angular elements on IE/Edge (#18062) |
| 09dc45942 | fix(form-field): delete top border from focus animation (#17885) |
| 527f1b596 | fix(form-field): deprecate `legacy` and `standard` appearances (#17961) |
| a6f235d5e | fix(form-field): incorrect assumptions about page direction (#17395) |
| 4663d8f8d | fix(form-field): annotate base class with Directive for Ivy (#17457) |
| 1d40ec974 | fix(form-field): ensure that descendants are picked up in Ivy (#17439) |
| 1b9429532 | fix(form-field): outline gap no calculated in shadow dom (#17303) |
| 914d40e3d | fix(form-field): FormField with outline doesn't work well with dir="r… (#15415) |
| 94c3fed9d | feat(form-field): allow hideRequiredMarker default value to be… (#16244) |
| cf11ed223 | fix(form-field): superfluous whitespace when compiled with bazel (#13911) |
| debc56e7d | fix(form-field): remove nonbreaking space before * for required fields (#15490) |
| 66dc61fa7 | fix(form-field): select value text blending in with the background in high contrast mode (#15286) |
| 63cec8f8d | fix(form-field): infinite loop with zone-patch-rxjs (#15335) |
| 360767793 | fix(form-field): allow user to click through arrow on native select (#15328) |
### form-field-benchmark
| Commit | Description |
| -- | -- |
| 513ef447c | fix(form-field-benchmark): fix component comment so that form field can sync properly (#19971) |
### grid-list
| Commit | Description |
| -- | -- |
| 044a360ec | fix(grid-list): not picking up indirect descendant lines (#17530) |
### icon
| Commit | Description |
| -- | -- |
| 4263cacba | fix(icon): not updating svg icon assigned through setter (#20509) |
| 5526ab9d0 | perf(icon): avoid unnecessarily parsing icon sets (#18654) |
| 092b1515f | feat(icon): add test harness (#20072) |
| 677be5857 | fix(icon): cancel in-flight icon requests if the icon changes (#19303) |
| 4778f4919 | fix(icon): use ErrorHandler to log MatIcon errors (#16999) |
| 425eb7e3b | fix(icon): not copying attributes from symbol nodes (#16896) |
| dccddd951 | fix(icon): use ErrorHandler to log MatIcon errors (#16967) |
| 75686e87f | fix(icon): use ErrorLogger to log http errors (#16855) |
| 363888602 | feat(icon): allow viewBox to be configured when registering icons (#16320) |
| cf03621ed | fix(icon): handle unescaped characters in names (#15678) |
| d64626670 | fix(icon): clearing user content when svgIcon is bound to falsy value (#15290) |
| b10dd043a | fix(icon): add notranslate class (#14889) |
| f6b428854 | fix(icon): clean up cached references in icon registry on destroy (#14801) |
### input
| Commit | Description |
| -- | -- |
| 0d4358156 | fix(input): changed after checked error if input has static placeholder (#20015) |
| d05ba6084 | fix(input): placeholder being read out twice by some screen readers (#10466) |
| da9c70728 | fix(input): incorrectly handling nested themes (#19637) |
| f8d9c96e5 | fix(input): avoid repeat accesses to check if element is a textarea (#19115) |
| fe151e6b7 | fix(input): avoid multiple autosize input listeners with ivy (#17817) |
| 265253281 | fix(input): no focus on click in IE if clicked outside native control (#15108) |
### input/testing
| Commit | Description |
| -- | -- |
| ca464bdd9 | feat(input/testing): add test harnesses for native select and option |
| 20e5ea966 | fix(input/testing): filtering by regex not working (#20148) |
| 7e5802a05 | fix(input/testing): unable to set the value of inputs that don't respond to typing (#18812) |
### int-bar
| Commit | Description |
| -- | -- |
| 78dc50bfa | perf(int-bar): Convert MatInkBarFoundation adapter to class object (#19986) |
### layout
| Commit | Description |
| -- | -- |
| 0d054db28 | fix(layout): breakpoint observer completing unrelated subscribers when preceding subscriber unsubscribes (#14988) |
### list
| Commit | Description |
| -- | -- |
| f9c5ffe41 | fix(list): determine if option value changed (#19828) (#19870) |
| 22eca833e | fix(list): don't redirect focus to first option on mouse focus (#19889) |
| 2eff545b7 | fix(list): single selection list selected state not shown on touch devices (#19877) |
| 7fde30524 | fix(list): selection list marked as touched when tabbing in (#19177) |
| 77f65e3e2 | fix(list): don't select disabled options when pressing ctrl + a (#18885) |
| 76e8a3864 | fix(list): no selected indication in high contrast mode while… (#18585) |
| ee3958d31 | fix(list): incorrectly selecting items when moving focus using shift + arrow key in single selection mode (#18579) |
| ea03ccec5 | fix(list): no disabled indication in high contrast mode (#18567) |
| c6a9f15e2 | fix(list): allow for list and list items to be disabled (#17584) |
| 3b242f00d | feat(list): Add single select mode. (#18126) |
| ad42a1b4c | fix(list): don't handle selection keys while using typeahead in selection list (#17826) |
| ee863b20a | fix(list): selection list option not picking up indirect desce… (#17514) |
| 2cefb6977 | fix(list): selection list checkbox theme overwritten by parent theme (#16939) |
| 400214036 | fix(list): matching item not preselected if added after init (#16080) |
| 40b335c35 | fix(list): form control cleared when list is destroyed (#16005) |
| a258400fd | fix(list): not picking up indirect descendant lines (#15552) |
| d6f2729d3 | fix(list): changed after checked error with preselected values in selection list (#15388) |
| ddeeb18b0 | fix(list): override native button text align in action list (#15404) |
| 3f8d02c2d | fix(list): action list missing focus and hover styling (#14147) |
| b98eb0307 | fix(list): disableRipple on selection list not affecting list options after init (#14858) |
| be2bc8f32 | fix(list): selection list not picking up indirect descendants (#15003) |
| 551ded50c | fix(list): deselect option if value doesn't match up (#14800) |
| 463ac9e49 | fix(list): disableRipple on list input not taking effect after init (#14836) |
| 73d0fb977 | fix(list): action list button outline not being reset on firefox (#14693) |
### mat-button-toggle
| Commit | Description |
| -- | -- |
| 92bbc7705 | fix(mat-button-toggle): mat-button-toggle element should not h… (#18746) |
### mat-paginator
| Commit | Description |
| -- | -- |
| f9c6d2aab | feat(mat-paginator): Optionally style the mat-paginator form-field (#18800) |
### material-expeirmental/mdc-form-field
| Commit | Description |
| -- | -- |
| db6511b40 | feat(material-expeirmental/mdc-form-field): separate out text and icon prefixes/suffixes (#21956) |
### material-expeirmental/mdc-list
| Commit | Description |
| -- | -- |
| d3c00c38f | feat(material-expeirmental/mdc-list): add support for focus/hover states and ripples (#19168) |
### material-experimenta/mdc-core
| Commit | Description |
| -- | -- |
| 2d4cab2fb | feat(material-experimenta/mdc-core): add test harnesses for MDC option and option group |
### material-experimental/*
| Commit | Description |
| -- | -- |
| 02db4ba07 | feat(material-experimental/*): Add focus indicators to all MDC except mdc-chips. (#18175) |
### material-experimental/button
| Commit | Description |
| -- | -- |
| b454e38e5 | fix(material-experimental/button): ripples were using mat-button styles (#17069) |
| fdefae0f2 | fix(material-experimental/button): ripple color should match state color (#17066) |
| a1e58631b | feat(material-experimental/button): add to universal app (#16997) |
| 7b12a8127 | feat(material-experimental/button): support unthemed version (#16986) |
| 7ad684cc6 | feat(material-experimental/button): anchor disabled state (#16962) |
| 8e975eeb6 | fix(material-experimental/button): buttons not outlined in high contrast mode (#16410) |
### material-experimental/checkbox
| Commit | Description |
| -- | -- |
| f178f20a7 | fix(material-experimental/checkbox): model value not updated through toggle method (#17229) |
| a487134b7 | fix(material-experimental/checkbox): focus/hover indication not working and incorrectly implementing ripples (#16877) |
### material-experimental/chip
| Commit | Description |
| -- | -- |
| 7581191f8 | feat(material-experimental/chip): add focus indicators (#18261) |
### material-experimental/chips
| Commit | Description |
| -- | -- |
| ebda4de64 | fix(material-experimental/chips): fix empty check when no chips (#20025) |
| ba3ec6ce8 | fix(material-experimental/chips): high contrast mode fixes (#16811) |
| d29df3813 | feat(material-experimental/chips): add grid keyboard shortcuts (#16384) |
| 86aad590f | feat(material-experimental/chips): MDC chip APIs match existing APIs (#16145) |
### material-experimental/drawer
| Commit | Description |
| -- | -- |
| 20019655d | feat(material-experimental/drawer): add harness for mat-drawer (#17010) |
### material-experimental/form-field
| Commit | Description |
| -- | -- |
| 5ef23badb | fix(material-experimental/form-field): fix notch width after appearance change (#19682) |
| 7b42c7e42 | fix(material-experimental/form-field): add setLabelRequired adapter (#19284) |
| 0bd1e4ab7 | fix(material-experimental/form-field): add  filled MDC text field class (#19103) |
| 7464d4b7d | feat(material-experimental/form-field): add test harness (#17138) |
### material-experimental/mdc
| Commit | Description |
| -- | -- |
| ae682d88d | fix(material-experimental/mdc): use state container for button interaction (#17284) |
### material-experimental/mdc-*
| Commit | Description |
| -- | -- |
| b91e88fd2 | fix(material-experimental/mdc-*): rename sass mixins to mat-md… (#18615) |
### material-experimental/mdc-autocomplete
| Commit | Description |
| -- | -- |
| 40cce7691 | fix(material-experimental/mdc-autocomplete): only animate along y axis (#21588) |
| 8aebd0398 | feat(material-experimental/mdc-autocomplete): add panel animation (#21525) |
| 3335a9295 | fix(material-experimental/mdc-autocomplete): panel losing max-height if menu is opened after autocomplete (#21394) |
| 9f695f259 | feat(material-experimental/mdc-autocomplete): add test harnesses |
| c8f03c760 | feat(material-experimental/mdc-autocomplete): implement MDC-based mat-autocomplete (#20247) |
### material-experimental/mdc-button
| Commit | Description |
| -- | -- |
| 32844962f | fix(material-experimental/mdc-button): set proper touch target (#22931) |
| 793e1f131 | fix(material-experimental/mdc-button): set proper touch target (#22846) |
| 08bbd50a6 | fix(material-experimental/mdc-button): remove unthemed icon color (#22281) |
| 17f66d693 | feat(material-experimental/mdc-button): add default config for FAB (#22102) |
| 56a9fc36a | fix(material-experimental/mdc-button): apply appropriate focus/actives styles to FAB (#22049) |
| 088a75694 | fix(material-experimental/mdc-button): add mdc ripple class for fab (#21923) |
| a96fbc6ca | fix(material-experimental/mdc-button): use mdc mixins to style icons within buttons (#21623) |
| 334ae2aed | fix(material-experimental/mdc-button): fix incomplete icon class targeting in styles (#21919) |
| f7ace54fe | feat(material-experimental/mdc-button): add extended fab (#21585) |
| c5a111d98 | fix(material-experimental/mdc-button): fix ripple noop animation (#21360) |
| 933e1e349 | fix(material-experimental/mdc-button): fix positioning of icons in text buttons (#20963) |
| 92bb1c89d | fix(material-experimental/mdc-button): narrow down overly-broad selector (#20969) |
| 55b74e354 | fix(material-experimental/mdc-button): align public API with material/button (#20679) |
| f2953dd41 | fix(material-experimental/mdc-button): double outline for FAB in high contrast mode (#20391) |
| 9500e751e | feat(material-experimental/mdc-button): support density scaling |
| d319e5623 | fix(material-experimental/mdc-button): strong focus indication always visible on fab buttons (#19169) |
| d19132965 | fix(material-experimental/mdc-button): add base css class to all buttons (#18422) |
| a8fde4a96 | fix(material-experimental/mdc-button): some button variants not visible in high contrast mode (#18036) |
| 9f9b017b9 | fix(material-experimental/mdc-button): rename state class (#17575) |
| 230403e4d | fix(material-experimental/mdc-button): elevate z-index of content (#17349) |
| 4dbf9f636 | fix(material-experimental/mdc-button): add ::after to reflect active styles (#17283) |
| 4a01df8c1 | feat(material-experimental/mdc-button): copy tests from button (#16926) |
| 9027c6f37 | feat(material-experimental/mdc-button): support disabled FAB (#16766) |
| c860e6064 | feat(material-experimental/mdc-button): focused state (#16819) |
| de06e59b2 | feat(material-experimental/mdc-button): fix ripples (#16773) |
| ee011341c | feat(material-experimental/mdc-button): use mat-mdc classnames in CSS (#16768) |
| 979f321ad | feat(material-experimental/mdc-button): support primary/accent/warn (#16782) |
| dab42c1b2 | feat(material-experimental/mdc-button): add component classnames per variant (#16767) |
### material-experimental/mdc-card
| Commit | Description |
| -- | -- |
| f88023c21 | fix(material-experimental/mdc-card): reset native header margin (#22550) |
| 4b1ee6f66 | feat(material-experimental/mdc-card): add appearance input (#22070) |
| 17de49c43 | fix(material-experimental/mdc-card): double outline in high contrast mode (#20823) |
| b69a75b4d | feat(material-experimental/mdc-card): add test harness (#20298) |
| 1c8a2c9f9 | fix(material-experimental/mdc-card): not handling dark themes (#18938) |
### material-experimental/mdc-checkbox
| Commit | Description |
| -- | -- |
| 437aba6e7 | fix(material-experimental/mdc-checkbox): add larger touch target (#22892) |
| 85b5df638 | fix(material-experimental/mdc-checkbox): fix mdc function name (#22198) |
| e6578d95f | fix(material-experimental/mdc-checkbox): add focus indication in high contrast mode |
| 7006b482c | fix(material-experimental/mdc-checkbox): remove background state styles (#21748) |
| 3e9a26c92 | fix(material-experimental/mdc-checkbox): fix broken dark theme (#20940) |
| 9b3992bcb | fix(material-experimental/mdc-checkbox): fix dark theme (#20926) |
| 84f2c1a00 | feat(material-experimental/mdc-checkbox): support density scaling |
| 4cc69d249 | feat(material-experimental/mdc-checkbox): add default options (#17578) |
### material-experimental/mdc-chips
| Commit | Description |
| -- | -- |
| 0003d8fde | fix(material-experimental/mdc-chips): remove icon click interaction (#22132) |
| 2f6189565 | fix(material-experimental/mdc-chips): decouple removal from animation (#21636) |
| 277ad5b40 | fix(material-experimental/mdc-chips): set correct ripple opacity for … (#21624) |
| 2d66ecbee | fix(material-experimental/mdc-chips): decouple removal from animation (#21586) |
| b07c5394c | fix(material-experimental/mdc-chips): align test harnesses with the non-MDC version (#21051) |
| d29ef7629 | feat(material-experimental/mdc-chips): add `remove` method to MDC chip harness (#20831) |
| 7596532e2 | fix(material-experimental/mdc-chips): use MDC-based form field (#20880) |
| 335fc0c05 | feat(material-experimental/mdc-chips): Allow custom role for ChipSet (#20829) |
| de542dfe9 | fix(material-experimental/mdc-chips): add missing functionality and align tests (#20814) |
| 04024fe8a | feat(material-experimental/mdc-chips): Make chips editable by connecting to the mdc web editing interface (#19618) |
| ee63f63c1 | fix(material-experimental/mdc-chips): removing chip on any key press (#19425) |
| ee1e1810c | feat(material-experimental/mdc-chips): support for density scaling |
| d5a9eaa15 | fix(material-experimental/mdc-chips): not disabling all animations when animations are disabled (#18440) |
| b225b8757 | fix(material-experimental/mdc-chips): enter animation not disabled when using noop animations (#18653) |
| f6206ce98 | fix(material-experimental/mdc-chips): align theming setup with… (#19000) |
| 96fd5856f | fix(material-experimental/mdc-chips): support custom errorStat… (#18974) |
| 262e2e49f | perf(material-experimental/mdc-chips): avoid checking the DOM on each change detection (#18929) |
| 54bbb906f | fix(material-experimental/mdc-chips): add feature targeting to… (#18830) |
| 433da5883 | fix(material-experimental/mdc-chips): align with latest MDC markup (#18472) |
| 1c2300f42 | fix(material-experimental/mdc-chips): don't allow focus on checkmark icon (#18588) |
| 4c08a88ad | fix(material-experimental/mdc-chips): leading icon not hidden on init when preselected (#17997) |
| bb08fa795 | fix(material-experimental/mdc-chips): chip removal not working if animations are disabled (#18314) |
| 847a4696f | fix(material-experimental/mdc-chips): support home/end in chip grid (#18052) |
| 403377dcc | fix(material-experimental/mdc-chips): removed chip still focus… (#18083) |
| 5fccd2405 | fix(material-experimental/mdc-chips): error on IE and Edge due… (#18074) |
| 7b7e633d5 | fix(material-experimental/mdc-chips): prevent default space an… (#18084) |
| 17a7bcb8d | fix(material-experimental/mdc-chips): avoid potential server-s… (#18044) |
| 55ee9880f | fix(material-experimental/mdc-chips): remove aria-hidden from… (#18054) |
| 99af8e9c3 | fix(material-experimental/mdc-chips): checkmark not visible in… (#18061) |
| 7aa522aa9 | fix(material-experimental/mdc-chips): use ripple target for state interactions (#17681) |
| 25c79cd38 | fix(material-experimental/mdc-chips): add checkmark container (#17694) |
| e7aeee417 | fix(material-experimental/mdc-chips): chip set not picking up… (#17568) |
| 52c33c76f | feat(material-experimental/mdc-chips): add harness skeleton (#16737) |
| 2994365a8 | fix(material-experimental/mdc-chips): incorrect selector for m… (#16722) |
| 93aba14c5 | fix(material-experimental/mdc-chips): ripple not being clipped in Safari (#16712) |
| 0e1e33ba9 | fix(material-experimental/mdc-chips): prevent ripple from esca… (#16670) |
### material-experimental/mdc-core
| Commit | Description |
| -- | -- |
| 64087316f | feat(material-experimental/mdc-core): set up MDC-based elevation (#22397) |
| 4a943f1f9 | fix(material-experimental/mdc-core): fix broken list option style (#22218) |
| ce7b92f96 | fix(material-experimental/mdc-core): rename core import file (#21953) |
| fc68d5c54 | fix(material-experimental/mdc-core): add missing symbols |
| 4f776792d | fix(material-experimental/mdc-core): expose same symbols as material/core (#20664) |
| 4b37b98fc | fix(material-experimental/mdc-core): option text not centered on IE11 (#20626) |
| 23b4c88ed | fix(material-experimental/mdc-core): active option not visible in high contrast mode (#20396) |
| 9a4adb7bb | fix(material-experimental/mdc-core): set up strong focus indication for MDC-based option (#20354) |
### material-experimental/mdc-dialog
| Commit | Description |
| -- | -- |
| 57c68e81e | fix(material-experimental/mdc-dialog): afterClosed being run outside of NgZone (#21702) |
| 1219b1e2f | fix(material-experimental/mdc-dialog): blending in with background in high contrast mode (#20387) |
### material-experimental/mdc-form-field
| Commit | Description |
| -- | -- |
| cabb9ce49 | fix(material-experimental/mdc-form-field): error with latest canary version (#22623) |
| f65d5b574 | fix(material-experimental/mdc-form-field): set explicit text-align (#22353) |
| 75e191dfd | fix(material-experimental/mdc-form-field): use coercion for boolean input (#22194) |
| 23a0248bc | fix(material-experimental/mdc-form-field): fix prefix/suffix padding (#22090) |
| a219a4aac | fix(material-experimental/mdc-form-field): fix height for form field with textarea (#22089) |
| d8935d17b | fix(material-experimental/mdc-form-field): always check hideRequiredMarker (#22068) |
| 62d2e37e6 | fix(material-experimental/mdc-form-field): allow shrinking in grid/flex layouts (#21820) |
| fc86fb543 | fix(material-experimental/mdc-form-field): remove extraneous sass var added by #21676 (#21772) |
| e5db56f9e | fix(material-experimental/mdc-form-field): tweak styles to work with MDC |
| 3aa552760 | fix(material-experimental/mdc-form-field): fill appearance blending in with the background in high contrast mode (#21446) |
| 27e60e853 | fix(material-experimental/mdc-form-field): fix fill appearance contrast ratio (#21365) |
| eb32025b3 | fix(material-experimental/mdc-form-field): add padding to subscript to align with spec (#21265) |
| 87dcfad7d | fix(material-experimental/mdc-form-field): make sure fonts are loaded before calculating notch width (#21245) |
| 02d334cef | fix(material-experimental/mdc-form-field): test harness referring to non-MDC harnesses (#20762) |
| c3aa76ec3 | fix(material-experimental/mdc-form-field): implement new methods added to text field adapter (#20739) |
| d8def8be6 | fix(material-experimental/mdc-form-field): not adding mat-primary theme class (#20605) |
| f4f0d959e | fix(material-experimental/mdc-form-field): update input alignment to match spec |
| 6bf7f246f | fix(material-experimental/mdc-form-field): do not show focus overlay when disabled |
| e3413baf5 | fix(material-experimental/mdc-form-field): show required asterisk for disabled fields |
| 3bcdc5ec4 | feat(material-experimental/mdc-form-field): support density scaling |
| 5284a57b2 | feat(material-experimental/mdc-form-field): expose `MAT_FORM_FIELD` injection token (#19277) |
| d4a962461 | fix(material-experimental/mdc-form-field): native select option blending in with background on dark themes (#19232) |
| 3f367d16b | fix(material-experimental/mdc-form-field): missing styles for native select controls (#19140) |
| eae5cf886 | fix(material-experimental/mdc-form-field): avoid expression ch… (#18741) |
| aea79f08e | fix(material-experimental/mdc-form-field): setup typography styles for form-fields (#18480) |
| 60d6bd63f | fix(material-experimental/mdc-form-field): prevent label from jumping in outline notch |
| 7fe838156 | fix(material-experimental/mdc-form-field): do not include outline structure styles in theme |
| 440ca6cbf | fix(material-experimental/mdc-form-field): fix incorrect floating label shift in RTL |
| b5f824855 | fix(material-experimental/mdc-form-field): properly render notched-outline on the server |
| 99e83a682 | fix(material-experimental/mdc-form-field): missing animation styles due to rebase conflict |
| f36f1f353 | fix(material-experimental/mdc-form-field): refresh view if prefix or suffix changes |
| 2497e50fb | fix(material-experimental/mdc-form-field): scrollbar always vi… (#18438) |
| b24b9e31c | feat(material-experimental/mdc-form-field): add support for ac… (#18399) |
| ed77ec9ca | feat(material-experimental/mdc-form-field): support for disabl… (#18397) |
| fc910613c | fix(material-experimental/mdc-form-field): notched-outline sho… (#18381) |
| 27111eb04 | feat(material-experimental/mdc-form-field): support theming through feature targeting (#18265) |
| f43e3e896 | fix(material-experimental/mdc-form-field): ensure validity styling is not reset by foundation (#18266) |
| 944837f32 | feat(material-experimental/mdc-form-field): add test harness (#18165) |
| 1ef30cb51 | fix(material-experimental/mdc-form-field): fix server side rendering failures (#18191) |
| 0c2635401 | fix(material-experimental/mdc-form-field): fix baseline and handle custom controls better (#18161) |
### material-experimental/mdc-form-filed
| Commit | Description |
| -- | -- |
| 5852fcb97 | fix(material-experimental/mdc-form-filed): missing focus and hover effect for fill |
### material-experimental/mdc-input
| Commit | Description |
| -- | -- |
| 21ab17fb1 | fix(material-experimental/mdc-input): only apply styling when inside a form field (#21876) |
| c8581a661 | fix(material-experimental/mdc-input): add autosize directive (#21105) |
| 80aeaf376 | fix(material-experimental/mdc-input): avoid double event listeners in ivy (#19052) |
| c07ec049a | feat(material-experimental/mdc-input): add test harness (#18224) |
| 500d235e2 | fix(material-experimental/mdc-input): input should not inherit parent classnames (#18180) |
### material-experimental/mdc-list
| Commit | Description |
| -- | -- |
| be872c06c | fix(material-experimental/mdc-list): error with latest MDC list canary version (#22636) |
| 67d6a031c | fix(material-experimental/mdc-list): align foundation methods with MDC (#22624) |
| 5e42d15b1 | fix(material-experimental/mdc-list): add selected indication in high contrast mode (#22447) |
| 4ad2d9608 | fix(material-experimental/mdc-list): align ripple timings with MDC (#22396) |
| 4f8e87e38 | fix(material-experimental/mdc-list): add high contrast mode treatment (#21376) |
| 5524942da | fix(material-experimental/mdc-list): rename mdc-list-* classes (#22157) |
| 8eb59f87e | fix(material-experimental/mdc-list): update mixin and variable names (#21968) |
| 4be7d155d | fix(material-experimental/mdc-list): not accounting for global ripple options (#21393) |
| c268246c0 | fix(material-experimental/mdc-list): make internal input non-interactive (#21438) |
| 3654a6319 | feat(material-experimental/mdc-list): add test harness |
| 96cc2a615 | fix(material-experimental/mdc-list): checkbox and icon alignment incorrect |
| fe14d8806 | feat(material-experimental/mdc-list): implement selection list (#20279) |
| 63da9e312 | fix(material-experimental/mdc-list): fix infinite loop on init (#19930) |
| 166bb5248 | feat(material-experimental/mdc-list): add MDC foundation for action/nav list (#19601) |
| e408228ad | fix(material-experimental/mdc-list): properly render leading and trailing icons on list items (#19201) |
| dd239dd94 | fix(material-experimental/mdc-list): fix styles for normal lists (#18632) |
| 45d34ad4f | feat(material-experimental/mdc-list): Add scaffolding for MDC-… (#17906) |
### material-experimental/mdc-mdc
| Commit | Description |
| -- | -- |
| dac84bfc2 | fix(material-experimental/mdc-mdc): menu items missing padding (#19634) |
### material-experimental/mdc-menu
| Commit | Description |
| -- | -- |
| 8ef4a7761 | fix(material-experimental/mdc-menu): implement increasing elevation (#22506) |
| 8fb560ff1 | fix(material-experimental/mdc-menu): apply typography to button menu items (#20169) |
| b618a96be | fix(material-experimental/mdc-menu): missing padding after latest canary release (#19548) |
| af7aa860a | fix(material-experimental/mdc-menu): menu item should not inherit parent classname (#17953) |
### material-experimental/mdc-menu/testing
| Commit | Description |
| -- | -- |
| e784f8f2f | fix(material-experimental/mdc-menu/testing): add unimplemented methods (#20352) |
### material-experimental/mdc-paginator
| Commit | Description |
| -- | -- |
| 5519131a7 | fix(material-experimental/mdc-paginator): rename module file (#22387) |
| ce9c905ba | fix(material-experimental/mdc-paginator): use MDC-based tooltip (#21895) |
| d7ec42c2c | fix(material-experimental/mdc-paginator): use caption typography for |
| 3bfad185d | fix(material-experimental/mdc-paginator): buttons not visible in high contrast mode (#21096) |
| 49a57bcf4 | feat(material-experimental/mdc-paginator): add test harness (#20686) |
| d87ae3c91 | feat(material-experimental/mdc-paginator): implement MDC-based paginator (#20607) |
### material-experimental/mdc-progress-bar
| Commit | Description |
| -- | -- |
| cd87b38dc | fix(material-experimental/mdc-progress-bar): buffer animation not disabled under noop animations module (#22661) |
| 4cf77164b | fix(material-experimental/mdc-progress-bar): don't rely on JS to change directionality (#22705) |
| 97f1cccd7 | fix(material-experimental/mdc-progress-bar): improve buffer color (#22152) |
| bd2c324d5 | fix(material-experimental/mdc-progress-bar): run resize observer outside zone (#21564) |
| cfd3bc8e4 | fix(material-experimental/mdc-progress-bar): check observer function (#21986) |
| cf085b4c4 | fix(material-experimental/mdc-progress-bar): account for breaking changes in latest canary |
| 289eecd25 | fix(material-experimental/mdc-progress-bar): changed after checked error on animation end event with noop animations (#18508) |
| 0753f9e76 | fix(material-experimental/mdc-progress-bar): update to latest canary to include adapter changes (#17938) |
### material-experimental/mdc-progress-spinner
| Commit | Description |
| -- | -- |
| 8ba714854 | fix(material-experimental/mdc-progress-spinner): set line-height (#22668) |
| 1371a85b4 | fix(material-experimental/mdc-progress-spinner): set to display block (#22618) |
| bf99037e1 | fix(material-experimental/mdc-progress-spinner): apply correct color in high contrast mode (#22435) |
| 768534dbc | fix(material-experimental/mdc-progress-spinner): fix aria-valuenow (#22429) |
| 37a9c4ee4 | fix(material-experimental/mdc-progress-spinner): indeterminate animation not working (#21391) |
| 71b7b1595 | fix(material-experimental/mdc-progress-spinner): fix noop animation (#21359) |
| efd8ab640 | fix(material-experimental/mdc-progress-spinner): prevent animation from affecting surrounding layout (#20962) |
### material-experimental/mdc-radio
| Commit | Description |
| -- | -- |
| 041f58246 | fix(material-experimental/mdc-radio): add accessible touch targets (#22994) |
| f11600034 | fix(material-experimental/mdc-radio): not removing animations when noop animations are enabled (#22651) |
| c791d6a6d | fix(material-experimental/mdc-radio): include form field core theme styles (#22071) |
| 9d929277d | fix(material-experimental/mdc-radio): de-duplicate test harness logic (#21532) |
| 5a28f0043 | fix(material-experimental/mdc-radio): include form field styles in mdc-radio theme (#21168) |
| 68b43740b | feat(material-experimental/mdc-radio): add test harness (#20283) |
| fb9174a34 | fix(material-experimental/mdc-radio): avoid hard references to base material components (#19403) |
| c659664b2 | feat(material-experimental/mdc-radio): support for density scaling |
| 506b74ab4 | fix(material-experimental/mdc-radio): avoid bundling styles from base radio button (#19032) |
| 3c99efc98 | fix(material-experimental/mdc-radio): strong focus indicator not working (#19091) |
| 8cfa8e84f | fix(material-experimental/mdc-radio): no focus indication in h… (#18969) |
| dc802800f | fix(material-experimental/mdc-radio): add strong focus indication (#18946) |
| 7ba45d9f2 | fix(material-experimental/mdc-radio): able to focus disabled radio button via click (#18584) |
| 76846b8b9 | fix(material-experimental/mdc-radio): use consistent ripple timings (#18590) |
| 59fce287a | feat(material-experimental/mdc-radio): add functionality and s… (#18272) |
### material-experimental/mdc-select
| Commit | Description |
| -- | -- |
| 10cc9cfa5 | fix(material-experimental/mdc-select): correct some differences between (#22108) |
| b99434933 | fix(material-experimental/mdc-select): float label on focus if there's a placeholder (#22187) |
| 16b7adb84 | fix(material-experimental/mdc-select): fix floating label behavior (#22134) |
| fef9179b6 | fix(material-experimental/mdc-select): arrow not rendering in high contrast mode (#21606) |
| c5300677b | fix(material-experimental/mdc-select): panel losing max-height if menu is opened after select (#21341) |
| 2df3ac2ac | fix(material-experimental/mdc-select): fix long labels being incorrectly cut off (#21184) |
| 29e1f266a | feat(material-experimental/mdc-select): add test harness (#20603) |
| 7f08922b4 | feat(material-experimental/mdc-select): implement MDC-based mat-select (#20502) |
### material-experimental/mdc-slide-toggle
| Commit | Description |
| -- | -- |
| 87ab033fe | fix(material-experimental/mdc-slide-toggle): increase contrast in high contrast mode (#22945) |
| c04bd21d6 | fix(material-experimental/mdc-slide-toggle): set $deprecated-suffix on import (#22645) |
| 2f702babc | feat(material-experimental/mdc-slide-toggle): swap to deprecated switch dependency (#22515) |
| 5cc960157 | fix(material-experimental/mdc-slide-toggle): add class to mdc-switch element (#21284) |
| b6872b472 | fix(material-experimental/mdc-slide-toggle): hide native focus outline (#20964) |
| f854196a8 | fix(material-experimental/mdc-slide-toggle): align focus behavior with standard version (#20772) |
| feafb2b98 | feat(material-experimental/mdc-slide-toggle): support density scaling |
| a2d041803 | fix(material-experimental/mdc-slide-toggle): strong focus indication not visible (#19048) |
| 636ae5c87 | fix(material-experimental/mdc-slide-toggle): update adapter to match new interface (#18124) |
| e746895ea | fix(material-experimental/mdc-slide-toggle): initial checked a… (#17991) |
| b98970164 | fix(material-experimental/mdc-slide-toggle): fix extra border… (#18035) |
| 3de0b0802 | fix(material-experimental/mdc-slide-toggle): missing focus indication in high contrast mode (#17471) |
### material-experimental/mdc-slider
| Commit | Description |
| -- | -- |
| 24d33a85a | fix(material-experimental/mdc-slider): align test harness inferred position with component (#22879) |
| f750db2ad | fix(material-experimental/mdc-slider): remove unused event emitters (#22921) |
| d5a5de2f5 | fix(material-experimental/mdc-slider): initialize the aria-valuetext … (#22877) |
| 4cee3b707 | fix(material-experimental/mdc-slider): delete isRequired function (#22876) |
| 0de3f7288 | fix(material-experimental/mdc-slider): expose theming mixins (#22764) |
| 89c847441 | fix(material-experimental/mdc-slider): disable animations when noop module is included (#22649) |
| aaf9ad203 | fix(material-experimental/mdc-slider): make small fixes needed to imp… (#22684) |
| 287834aec | feat(material-experimental/mdc-slider): add test harnesses (#22648) |
| 8dcc94dcf | feat(material-experimental/mdc-slider): implement the mdc slider (#22596) |
| d952a2201 | fix(material-experimental/mdc-slider): remove slider theme from all-theme (#19411) |
| 5460fabe7 | fix(material-experimental/mdc-slider): resolve warnings about active event listeners (#18583) |
| 40665e96e | fix(material-experimental/mdc-slider): remove theme import from all-theme (#17348) |
| da14f16af | fix(material-experimental/mdc-slider): not usable in high contrast mode (#17164) |
### material-experimental/mdc-snack-bar
| Commit | Description |
| -- | -- |
| 16a5aba26 | fix(material-experimental/mdc-snack-bar): increase the specificity of styles targeting the action buttons (#22959) |
| 9f879b291 | fix(material-experimental/mdc-snack-bar): use MDC-based button (#21442) |
| 85a88545e | fix(material-experimental/mdc-snack-bar): not stretching to full width on handset (#21477) |
| 9f5cfbd0a | fix(material-experimental/mdc-snack-bar): simple snack button should be accent (#21384) |
| bcbdb74f8 | fix(material-experimental/mdc-snack-bar): disable animations in noop (#21377) |
| cf4aa5123 | fix(material-experimental/mdc-snack-bar): add missing exports (#20928) |
| 50d3f29b6 | fix(material-experimental/mdc-snack-bar): button pushed outside container (#20696) |
| c9fcbef10 | fix(material-experimental/mdc-snack-bar): not aligned correctly on IE11 (#20690) |
| 4aa871815 | feat(material-experimental/mdc-snack-bar): add test harness (#20366) |
| 747a5d845 | fix(material-experimental/mdc-snack-bar): blending in with background in high contrast mode (#19996) |
| 912ad8dcf | fix(material-experimental/mdc-snack-bar): error during server-side rendering (#19922) |
| a9e0ac564 | fix(material-experimental/mdc-snack-bar): support dark themes (#19926) |
### material-experimental/mdc-snackbar
| Commit | Description |
| -- | -- |
| 3ca7c5a25 | feat(material-experimental/mdc-snackbar): Add demo. (#17895) |
| 6bda71814 | feat(material-experimental/mdc-snackbar): add skeleton (#17161) |
### material-experimental/mdc-table
| Commit | Description |
| -- | -- |
| ade090104 | fix(material-experimental/mdc-table): add background inherit to header cells (#22751) |
| 0611a0dce | fix(material-experimental/mdc-table): add background color; disable hover styles; fix sticky columns (#22723) |
| dc33472ac | fix(material-experimental/mdc-table): don't import template from other (#21594) |
| 1ce49a37c | fix(material-experimental/mdc-table): remove bottom border for flex table (#21566) |
| 2255b66ab | fix(material-experimental/mdc-table): error when flexbox-based table is initialized (#21428) |
| f0f3748b7 | feat(material-experimental/mdc-table): add mat-table selector (#20994) |
| b6be078e8 | fix(material-experimental/mdc-table): Fix sticky scrolling (#21211) |
| f7d7502f9 | fix(material-experimental/mdc-table): export missing symbols (#20924) |
| 55f788200 | fix(material-experimental/mdc-table): reset table layout (#20364) |
| 880908492 | feat(material-experimental/mdc-table): add test harnesses (#20319) |
| e28855831 | feat(material-experimental/mdc-table): support for density scaling |
| 447f2e6af | fix(material-experimental/mdc-table): not supporting multiple themes (#18931) |
| 8796d7cc6 | feat(material-experimental/mdc-table): add tests (#18003) |
| bb68c7b4a | feat(material-experimental/mdc-table): add MDC styles/classes (#18000) |
| 4169c6f78 | feat(material-experimental/mdc-table): add skeleton (#17992) |
### material-experimental/mdc-tabs
| Commit | Description |
| -- | -- |
| 61ce45da1 | fix(material-experimental/mdc-tabs): ink bar animation not always disabled (#22848) |
| da5e2eb39 | fix(material-experimental/mdc-tabs): support backgroundColor on nav bar (#21746) |
| c266f3b88 | fix(material-experimental/mdc-tabs): delete custom tab min-width (#20979) |
| 3854b664f | feat(material-experimental/mdc-tabs): add test harnesses (#20322) |
| 0777c44c0 | fix(material-experimental/mdc-tabs): missing focus indication in high contrast mode (#17601) |
| 90d294b1f | feat(material-experimental/mdc-tabs): support for density scaling |
| 9c137720f | fix(material-experimental/mdc-tabs): not disabling all animati… (#18446) |
| 86a4ba790 | fix(material-experimental/mdc-tabs): incorrect tab text color in dark theme (#18068) |
| 71165f103 | fix(material-experimental/mdc-tabs): markForCheck on ink bar content input setter (#17561) |
| 2f843891c | feat(material-experimental/mdc-tabs): add default fitInkBarToContent option (#17556) |
| 77d51ca42 | feat(material-experimental/mdc-tabs): add option to fit ink bar to content (#17507) |
| 409e656bc | fix(material-experimental/mdc-tabs): add `.mdc-tab__ripple` container (#17498) |
| baec85e4e | fix(material-experimental/mdc-tabs): error during server-side rendering (#17169) |
### material-experimental/mdc-theming
| Commit | Description |
| -- | -- |
| 0f9c1e6ef | fix(material-experimental/mdc-theming): prefix elevation mixins with mdc (#22600) |
### material-experimental/mdc-tooltip
| Commit | Description |
| -- | -- |
| da604bf26 | fix(material-experimental/mdc-tooltip): fix text alignment of multili… (#22981) |
| a96c1c37c | fix(material-experimental/mdc-tooltip): add mdc-tooltip__surface-animation class as MDC is splitting up animation and visual styles (#22346) |
| 716158724 | fix(material-experimental/mdc-tooltip): change class prefixes to mat-mdc (#22025) |
| 5e4d5e0bf | feat(material-experimental/mdc-tooltip): add test harness (#21855) |
| 6eff9386b | feat(material-experimental/mdc-tooltip): implement MDC-based tooltip (#21735) |
### material-experimental/mdc-typography
| Commit | Description |
| -- | -- |
| 5f1f4a1f5 | fix(material-experimental/mdc-typography): add missing @import forward (#22519) |
| 79708d424 | fix(material-experimental/mdc-typography): change transform to none (#21964) |
| 07eb0f7ff | fix(material-experimental/mdc-typography): strip typography properties (#21878) |
| 8f22f5ecb | fix(material-experimental/mdc-typography): update components using incorrect typography levels |
| 12488cb50 | feat(material-experimental/mdc-typography): add a function to create |
| b8cdb83d6 | fix(material-experimental/mdc-typography): change mdc components to prefer |
| a9db92089 | fix(material-experimental/mdc-typography): fix always using mat-level (#21669) |
### material-experimental/menu
| Commit | Description |
| -- | -- |
| ba7cbe726 | fix(material-experimental/menu): missing outline and focus indication in high contrast mode (#16871) |
### material-experimental/menubar
| Commit | Description |
| -- | -- |
| 06a9843ef | feat(material-experimental/menubar): update the dev-app to include a fake mat-menu (#20365) |
| fd2976f6a | feat(material-experimental/menubar): extends components from cdk menu equivalents (#20301) |
### material-experimental/popover-edit
| Commit | Description |
| -- | -- |
| 1dd57ffc9 | fix(material-experimental/popover-edit): closing instantly when opening with enter key (#18444) |
| 421ce3a3d | fix(material-experimental/popover-edit): inconsistent theme naming (#16884) |
### material-experimental/progress-bar
| Commit | Description |
| -- | -- |
| b30aedda8 | fix(material-experimental/progress-bar): server-side rendering error (#17359) |
### material-experimental/radio
| Commit | Description |
| -- | -- |
| cc9793f20 | fix(material-experimental/radio): redefine theme variables (#18907) |
| 7c75d6ef4 | fix(material-experimental/radio): remove input click handler (#18868) |
| 8e141efee | fix(material-experimental/radio): rename mdc-radio APIs to match existing radio APIs (#17178) |
| 67f3c0b14 | feat(material-experimental/radio): Set up the MDC foundation (#17180) |
| 2112fac64 | feat(material-experimental/radio): use MDC DOM structure and styles (#17179) |
### material-experimental/slide-toggle
| Commit | Description |
| -- | -- |
| 6c212b74c | fix(material-experimental/slide-toggle): fix focus indictor position (#19551) |
| 1cca459b3 | fix(material-experimental/slide-toggle): redefine more variables (#18908) |
| 4d7ffaa3a | fix(material-experimental/slide-toggle): allow different densities (#18895) |
### material-experimental/slider
| Commit | Description |
| -- | -- |
| 2b937f15b | fix(material-experimental/slider): add slider mixin to main theme mixin (#18384) |
| 7bee53f86 | fix(material-experimental/slider): incorrectly rendering extra background (#17207) |
### material-experimental/snack-bar
| Commit | Description |
| -- | -- |
| 7dcd2dd28 | feat(material-experimental/snack-bar): add MDC-based snack-bar (#19800) |
| a63bfc549 | feat(material-experimental/snack-bar): add MDC-based snack-bar (#19738) |
### material-experimetal/mdc-form-field
| Commit | Description |
| -- | -- |
| b2e86918e | fix(material-experimetal/mdc-form-field): account for breaking changes in MDC (#18795) |
### material/autocomplete
| Commit | Description |
| -- | -- |
| 0fbd3e752 | fix(material/autocomplete): error if keydown is dispatched too early (#22513) |
| ee499222d | fix(material/autocomplete): avoid assigning invalid aria-labelledby values (#22261) |
| 3bbc0a07d | fix(material/autocomplete): prevent inert host node from affecting surrounding layout (#21649) |
| f4436e2ae | fix(material/autocomplete): activate first enabled option with autoActiveFirstOption (#21513) |
| bed1a6fb8 | fix(material/autocomplete): not closing when clicking outside using auxilliary button (#21397) |
| 8ee56a5b2 | fix(material/autocomplete): add missing aria-label for autocomplete panel (#20892) |
| 3866761c9 | fix(material/autocomplete): options inside groups not read out with VoiceOver (#20819) |
| d8396f293 | fix(material/autocomplete): don't prevent escape key actions with modifiers (#20706) |
| 3c2334cb3 | feat(material/autocomplete): add panelClass default option (#20429) |
### material/autocomplete/testing
| Commit | Description |
| -- | -- |
| 7a748fca8 | feat(material/autocomplete/testing): polish harness API (#17350) |
### material/badge
| Commit | Description |
| -- | -- |
| cf54d8b63 | fix(material/badge): avoid emitting the structural styles more than once (#23011) |
### material/bottom-sheet
| Commit | Description |
| -- | -- |
| 704415385 | fix(material/bottom-sheet): focus restoration not working inside shadow dom (#21975) |
| d8afc38d7 | fix(material/bottom-sheet): some changes not being picked up (#21175) |
### material/button
| Commit | Description |
| -- | -- |
| 54d6b3e28 | fix(material/button): anchor mat-icon-button as matSuffix focus misaligned (#21117) |
| 23d0b80ba | feat(material/button): allow focus origin to be optional input in focus method (#20898) |
| 345ad70ef | fix(material/button): add more prominent focus indication in high contrast mode (#20821) |
### material/button-toggle
| Commit | Description |
| -- | -- |
| 39e4e2411 | fix(material/button-toggle): fix ChromeVox focus issue on button toggle (#21046) |
### material/card
| Commit | Description |
| -- | -- |
| 619d5919b | fix(material/card): not clearing margin on last button in end alignment (#20040) |
### material/checkbox
| Commit | Description |
| -- | -- |
| 561a38d1e | fix(material/checkbox): disable ripple animation under noop animations module (#22706) |
| c67941602 | fix(material/checkbox): native input not in sync if checked state is changed inside event (#22316) |
| 205a2f527 | fix(material/checkbox): add more prominent focus indication in high contrast mode |
| 5e9cc5f88 | fix(material/checkbox): no color assigned if defaults don't have a color (#21042) |
| 94bd0d498 | feat(material/checkbox): Avoid nested divs in labels by changing to span instead. (#20990) |
| d686290ff | fix(material/checkbox): set display on host node (#20961) |
| 5575673b4 | feat(material/checkbox): allow focus origin to be optional input in focus method (#20905) |
### material/chip
| Commit | Description |
| -- | -- |
| 78cfd3c2a | feat(material/chip): Add focus indicator (#18019) |
### material/chips
| Commit | Description |
| -- | -- |
| 623056083 | feat(material/chips): prevent chips from being deleted when user holds backspace (#19700) |
| 41ac7730e | fix(material/chips): ripple not disabled when animations are disabled (#20982) |
| 5f2407eb0 | feat(material/chips): add test harnesses for selectable chips (#20875) |
| e7508adfb | fix(material/chips): fix ripple element opacity when using CSS variable theming (#17576) |
### material/core
| Commit | Description |
| -- | -- |
| a1d3467b6 | fix(material/core): typography-hierarchy mixin not exposed (#22752) |
| 3027f8c22 | fix(material/core): reduce the number of module resolutions required for the legacy theming bundle |
| 8eb702edf | fix(material/core): reduce the number of module resolutions required for the legacy theming bundle |
| 491d2ec57 | fix(material/core): `mat-ripple-element` is not fired on disable (#22537) |
| d92f8f25b | fix(material/core): update mixin functions to avoid unknown cast (#22577) |
| dd1d28f69 | fix(material/core): expose mixin mentioned in the elevation guide (#22426) |
| 40ceda28f | feat(material/core): expose new @use-based Sass API (#22173) |
| 8b3c82d7d | fix(material/core): restore private- mixin prefix (#21989) |
| 53e98b146 | feat(material/core): migrate to the Sass module system (#21204) |
| ca37709ca | fix(material/core): mat-optgroup labels are read twice during screen-reader page navigation. (#21858) |
| e608da306 | fix(material/core): unable to distinguish disabled mat-option in high contrast mode (#21484) |
| 1a6f9f4f3 | feat(material/core): add typography config normalization function (#21059) |
| 042b8fc11 | feat(material/core): add date format for month label (#21044) |
| dd49fa69d | fix(material/core): incorrectly formatting dates in the years 0 to 99 (#20612) |
### material/datepicker
| Commit | Description |
| -- | -- |
| f9ea7188f | fix(material/datepicker): incorrect appearance when used in MDC form field (#23028) |
| 5b74a0d69 | fix(material/datepicker): correct structure for grid role (#23022) |
| 2045d0b37 | fix(material/datepicker): Return union of view component types (#23000) |
| f3c30962e | fix(material/datepicker): incorrect year count in aria label (#22763) |
| 736782344 | fix(material/datepicker): pass correct inject flags to injector (#22665) |
| b8475350d | fix(material/datepicker): add label to dialog overlay (#22625) |
| 979a4fadf | fix(material/datepicker): Only update selection when value changed (#21846) (#22369) |
| 355233dcf | fix(material/datepicker): support for date range input in MDC-based form field (#22565) |
| 7cc42f5d8 | fix(material/datepicker): range picker placeholders not hidden in high contrast mode |
| 7039d3e00 | feat(material/datepicker): remove dependency on dialog (#22383) |
| ea5e5e04d | fix(material/datepicker): toggle icon not visible in high contrast mode on Chromium browsers (#22352) |
| 8497bb166 | fix(material/datepicker): hide date selection model from docs (#22056) |
| deebaae08 | fix(material/datepicker): avoid interfering with external click listener (#21856) |
| 85d8de935 | fix(material/datepicker): focus restoration not working inside shadow dom (#21796) |
| 192efb80a | fix(material/datepicker): reset preview range after selecting a date (#21591) |
| 2e783b428 | fix(material/datepicker): clear tabindex from host node (#21633) |
| b559786f7 | fix(material/datepicker): mark date input as touched when calendar is closed (#21646) |
| 6d726f491 | feat(material/datepicker): allow for focus restoration to be disabled (#21444) |
| 13aa3598c | fix(material/datepicker): remove scroll bar while animating in touch UI mode (#21493) |
| 791af8227 | fix(material/datepicker): unable to distinguish disabled calendar cells in high contrast mode (#21399) |
| 8f0e654b3 | fix(material/datepicker): unable to pass in errorStateMatcher through binding on range input (#21210) |
| d5908473b | feat(material/datepicker): add support for cancel/apply buttons (#21487) |
| 4b1602550 | fix(material/datepicker): range input controls dirty on init (#21223) |
| f7bd2242e | fix(material/datepicker): a couple of accessibility issues in touch UI mode (#21228) |
| dfe3236ce | fix(material/datepicker): adjust focused date background for better visibility (#21176) |
| d4f2fa630 | fix(material/datepicker): screen reader not announcing view switch button value (#21229) |
| 975fbb3a7 | fix(material/datepicker): don't invoke change handler when filter is swapped out if result is the same (#20970) |
| 4874320bb | feat(material/datepicker): allow for datepicker toggle aria-label to be customized (#21077) |
| d9cc05513 | fix(material/datepicker): screen reader close button style specificity too low (#21058) |
| 57a366117 | fix(material/datepicker): range input emitters not picked up by language service (#20937) |
| 5b1660e09 | feat(material/datepicker): allow custom pickers with date inputs (#20864) |
| 513bfa49b | fix(material/datepicker): input harness not dispatching dateChange event (#20877) |
| 54f36a3e6 | fix(material/datepicker): don't handle escape key presses with modifier (#20713) |
| 407398f6e | fix(material/datepicker): add close button for screen readers (#20666) |
| b59e4a18c | fix(material/datepicker): lifecycle hooks not being called (#20700) |
| b3f1fb34a | fix(material/datepicker): fix handling of short years (#20709) |
| f0e56f01a | feat(material/datepicker): add `getValidDateOrNull` method (#19915) |
### material/dialog
| Commit | Description |
| -- | -- |
| be508daa2 | fix(material/dialog): focus restoration not working inside shadow dom (#21811) |
| 43b463feb | fix(material/dialog): incorrect action height if box-sizing is configured globally (#20889) |
### material/expansion
| Commit | Description |
| -- | -- |
| 6c1383a33 | fix(material/expansion): unable to assign custom tabindex on header (#22523) |
| d3deb8b9c | fix(material/expansion): add focus indication in high contrast mode (#21549) |
| 20766868b | fix(material/expansion): not clearing custom query list (#21222) |
| ea2f29db9 | feat(material/expansion): allow focus origin to be optional input in focus method (#20912) |
| acfa17427 | feat(material/expansion): add test harness (#17691) |
### material/expansion-panel
| Commit | Description |
| -- | -- |
| dddbca285 | fix(material/expansion-panel): Fix clipped box-shadow between… (#18378) |
### material/focus-indicators
| Commit | Description |
| -- | -- |
| 574345cf7 | feat(material/focus-indicators): add config map to base focus indicators mixin, adjust default styles (#19206) |
### material/form-field
| Commit | Description |
| -- | -- |
| f9cc56418 | fix(material/form-field): handle datepicker inputs in harness (#22403) |
| 635ee67f3 | fix(material/form-field): input placeholder not hidden in high contrast mode |
| a405ce6ce | feat(material/form-field): make mat-errors more polite (#21870) |
| 048431057 | fix(material/form-field): focus indication not working for standard appearance in high contrast mode (#21805) |
| ac121f874 | fix(material/form-field): flickering when hovering invalid input on chrome (#21620) |
| a087edd6c | fix(material/form-field): dynamic hint end alignment not working (#20657) |
| d550e4ef9 | fix(material/form-field): undeprecated legacy and standard appearances (#18144) |
### material/grid-list
| Commit | Description |
| -- | -- |
| 4b11445a9 | fix(material/grid-list): remove mat-figure class (#22231) |
| b4fafdad7 | fix(material/grid-list): remove internal figure element (#21826) |
| 5e9ca2893 | feat(material/grid-list): add test harness (#18001) |
### material/icon
| Commit | Description |
| -- | -- |
| 1fb03ceaa | feat(material/icon): add support for registry resolver function (#21431) |
| 77730e9c3 | feat(material/icon): allow fetching icons with credentials (#18896) |
| 71955d2e1 | feat(material/icon): New FakeMatIconRegitry for unit tests (#18151) |
### material/icon/testing
| Commit | Description |
| -- | -- |
| 27ef8425f | fix(material/icon/testing): Adds size specs to fake icon (#18306) |
### material/input
| Commit | Description |
| -- | -- |
| d1852940d | fix(material/input): Do not set `aria-invalid` on required empty `matInput`s (#22802) |
| 0059efbdf | fix(material/input): error for some input types on iOS (#22749) |
| d0c53ac96 | fix(material/input): only set as aria-invalid if the input isn't empty (#21609) |
| 915791b65 | fix(material/input): uncessary scroll bar on auto-resize textarea in some cases (#21619) |
| 7d511ba4a | fix(material/input): do not override existing aria-describedby value (#19587) |
| fe0e963a0 | fix(material/input): input harness not matching `matNativeControl` (#18221) |
| 8f62ffe73 | fix(material/input): apply static class binding to host (#18196) |
### material/list
| Commit | Description |
| -- | -- |
| 770217726 | fix(material/list): dispatching model change event multiple times in single selection mode (#22376) |
| ae6e930bf | feat(material/list): return selected options from selection list selectAll/deselectAll (#21358) |
| db7ff985a | feat(material/list): introduce type for checkbox position |
| dfdd42250 | fix(material/list): exclude icons from harness getText result (#20845) |
| 628b5e9fd | fix(material/list): emit selectionChange event when selecting with ctrl + a (#20667) |
| 998bb18ab | fix(material/list): use flexbox to size mat-line elements (#19809) (#19819) |
| fd1593df1 | fix(material/list): Selection List element should not be focus… (#18445) |
| 49b6dbd36 | feat(material/list): add test harnesses for list components (#17859) |
| 4301fb0fa | fix(material/list): Do not rely on input binding order (#17501) |
### material/list/testing
| Commit | Description |
| -- | -- |
| 8d643a069 | fix(material/list/testing): avoid element selectors that could conflict with the MDC version (#20528) |
### material/mdc-form-field
| Commit | Description |
| -- | -- |
| 26ab43bde | fix(material/mdc-form-field): text-field should stretch based on host element (#18778) |
### material/menu
| Commit | Description |
| -- | -- |
| aeecb3ccb | fix(material/menu): not interrupting keyboard events to other overlays (#22856) |
| ad248652e | feat(material/menu): allow updating menu position a la autocomplete (#22046) |
| 510672e03 | fix(material/menu): prevent mat-menu from affecting flex layout (#21246) |
| d3cdb345e | fix(material/menu): unable to move focus from inside opened event (#20968) |
| 21cae4802 | fix(material/menu): nested menu trigger not restoring focus (#21531) |
| bf34cdbbd | fix(material/menu): focus indication rendering partially in high contrast mode (#21527) |
| 83f2adc7b | fix(material/menu): allow menu height to grow after open (#21436) |
| 3484f711b | fix(material/menu): set correct focus origin on item when opened via keyboard (#21252) |
| 377378b35 | fix(material/menu): clear static aria attributes from host node (#21231) |
| 832d2a080 | fix(material/menu): icons in menu not inheriting disabled color (#20948) |
| 260f0607f | feat(material/menu): allow focus origin to be optional input in focus method (#20907) |
| a461929b1 | fix(material/menu): getLabel not working if text is inside indirect descendant node (#20705) |
### material/menu/testing
| Commit | Description |
| -- | -- |
| aa2cbf79d | feat(material/menu/testing): finish implementing harness (#17379) |
### material/ng-update
| Commit | Description |
| -- | -- |
| f06597715 | feat(material/ng-update): add migration for hammerjs in version 9 (#17369) |
### material/paginator
| Commit | Description |
| -- | -- |
| f06ff2a43 | fix(material/paginator): add `role="group"` to host (#22512) |
| d056f9869 | fix(material/paginator): button icons blending in with background in high contrast mode on Chromium browsers (#22385) |
| 7335c6530 | fix(material/paginator): remove unnecessary @ViewChild in harness test (#20943) |
### material/progress-bar
| Commit | Description |
| -- | -- |
| a9cdb084d | fix(material/progress-bar): fix screenreader not reading aria-label (#22201) |
| 5b7b03ea7 | fix(material/progress-bar): Support ChromeVox (#22166) |
| 94d585080 | fix(material/progress-bar): adjust buffer colors (#22164) |
### material/progress-spinner
| Commit | Description |
| -- | -- |
| 03cc48d18 | fix(material/progress-spinner): not visible in high contrast mode on chromium browsers (#22364) |
| 2da7135e4 | fix(material/progress-spinner): resolve accessibility issue in ChromeVox (#22219) |
| 2c47b068c | fix(material/progress-spinner): Progress spinner animation fails for floating point diameter values (#20192) |
### material/radio
| Commit | Description |
| -- | -- |
| babf80f6f | fix(material/radio): disable ripples under noop animations module (#22855) |
| c45cd69f3 | fix(material/radio): ripple not positioned correctly inside parent with centered text (#22391) |
| 2e1214f87 | fix(material/radio): add high contrast focus indication (#22145) |
| cdfc46b9b | fix(material/radio): remove tabindex from host node (#21280) |
| 6cd1dbe5f | fix(material/radio): group selected button not set for preselected control value (#21154) |
| 86be28e07 | feat(material/radio): Avoid nested divs in labels by changing to span instead. (#20986) |
| e3032451a | feat(material/radio): allow focus origin to be optional input in focus method (#20911) |
### material/radio/testing
| Commit | Description |
| -- | -- |
| 36d34a641 | feat(material/radio/testing): polish harness API (#17414) |
### material/schematics
| Commit | Description |
| -- | -- |
| 3c140fdb7 | fix(material/schematics): incorrectly migrating some cases (#22983) |
| 00290976c | fix(material/schematics): don't insert duplicate `@use` statements in themingApi (#22755) |
| 7cd084d56 | fix(material/schematics): don't drop prebuilt imports in theming API migration |
| cd12aa790 | fix(material/schematics): theming migration schematic not inserting use statement at the top of the file in some cases |
| eca9b64d3 | fix(material/schematics): log message at the end of the theming migration |
| d5f452338 | fix(material/schematics): only migrate unprefixed variables when there is an import |
| c20bdd5ff | fix(material/schematics): external stylesheets cannot be migrated |
| bd063bf48 | fix(material/schematics): run theming API migration during ng update |
| 94bb51880 | fix(material/schematics): migrate more cases in the theming API schematic (#22604) |
| 04d2f7709 | fix(material/schematics): replace removed variables with their values in sass api migration (#22505) |
| d030a8712 | fix(material/schematics): don't drop imports in files that do not use theming APIs (#22438) |
| 0cb27f95c | fix(material/schematics): switch custom theme schematic to `@use` (#22436) |
| 183c59f49 | feat(material/schematics): add migration to switch to the new theming API (#22304) |
| 0441ae9e5 | fix(material/schematics): generate code that works in strict CLI projects (#22052) |
| 8f558eeb7 | fix(material/schematics): fix typo in warning (#21754) |
| 461602d4a | feat(material/schematics): use newer Google Fonts version (#21479) |
| 31723b858 | feat(material/schematics): enable routing option (#19439) |
| f32fb68b7 | fix(material/schematics): support stricter TypeScript compiler flags (#17159) |
### material/select
| Commit | Description |
| -- | -- |
| 9b67d670b | fix(material/select): trim aria-labelledby (#22251) |
| 7a972fbe3 | fix(material/select): float label on focus if there's a placeholder (#19517) |
| cfbbbfea1 | fix(material/select): value not updated if the same array is updated and re-assigned (#21625) |
| 9f913aa90 | fix(material/select): VoiceOver reading out blank space (#21733) |
| da1f7e7a5 | fix(material/select): overlay offset calculation for disabled option centering (#21716) |
| ab01f3850 | fix(material/select): incorrect default typeahead debounce time (#21253) |
| 44b7e1a57 | fix(material/select): remove focus outline on panel (#21005) |
| 33a43f7b0 | fix(material/select): make VoiceOver read options for selects in dialogs (#20695) |
| 17a9ad021 | feat(material/select): add a global option to specify overlay panel class (#20702) |
| c4078aa2a | fix(material/select): option active styling not removed when value is changed programmatically (#20649) |
| 14cdd8954 | fix(material/select): fix recursive call to SelectionModel.select() (#17071) |
### material/sidenav
| Commit | Description |
| -- | -- |
| 2fa78c6fe | fix(material/sidenav): mark sidenav content as scrollable (#19848) |
| 63641c5fe | feat(material/sidenav): add test harnesses for container and content elements (#21115) |
### material/sidenav/testing
| Commit | Description |
| -- | -- |
| 9e79940e5 | feat(material/sidenav/testing): polish harness API (#17415) |
### material/slide-toggle
| Commit | Description |
| -- | -- |
| e5e1b18c5 | fix(material/slide-toggle): Made label non user selectable (#22756) |
| 62be7b39c | fix(material/slide-toggle): disable ripples when animations are disabled (#22713) |
| 5c7e5573f | feat(material/slide-toggle): allow for default color to be configured globally (#22047) |
| a0d4ce302 | feat(material/slide-toggle): allow origin to be optional input in focus method (#20913) |
### material/slide-toggle/testing
| Commit | Description |
| -- | -- |
| db999fffc | feat(material/slide-toggle/testing): polish harness API (#17416) |
### material/slider
| Commit | Description |
| -- | -- |
| 71afc4616 | fix(material/slider): make value non-nullable (#22912) |
| 23dfbbb23 | fix(material/slider): don't interrupt pointer dragging when keyboard is pressed (#22849) |
| 2f40a8dcc | fix(material/slider): incorrectly attributing touches for multiple touch events (#22615) |
| 69a8fb54d | feat(material/slider): show background-color in print stylesheet (#11364) (#22300) |
| e95edadfa | fix(material/slider): unable to assign min/max values if they are more precise than then step (#21155) |
| 9f4415efa | fix(material/slider): some screen readers announcing long decimal values (#20870) |
| 19f5f5ca3 | fix(material/slider): some screen readers announcing long decimal values (#20760) |
| d93e16f5d | fix(material/slider): some screen readers announcing long decimal values (#20721) |
| 3bae80012 | fix(material/slider): inject document token (#18275) |
### material/snack-bar
| Commit | Description |
| -- | -- |
| c08e2c9cc | fix(material/snack-bar): clear timeout upon dismiss with action (#22485) |
| 6cd27165a | fix(material/snack-bar): fix Firefox/JAWS not reading out snackbar message (#21552) |
| cf8e8eee2 | fix(material/snack-bar): flaky screen reader announcements for NVDA/JAWS (#20487) |
| 6a732d324 | feat(material/snack-bar): add test harness for snack-bar (#17127) |
### material/snackbar
| Commit | Description |
| -- | -- |
| 6e70cc706 | feat(material/snackbar): add `isDismissed` harness method (#18766) |
### material/sort
| Commit | Description |
| -- | -- |
| 68600b8f4 | fix(material/sort): fix undefined object access (#22634) |
| ca7d37919 | fix(material/sort): view not updated when sort state is changed through binding (#19492) |
| dff4a3ca2 | feat(material/sort): Add default configuration options (#21648) |
| 4efb44a47 | fix(material/sort): animation not working correctly when activated on focus (#21339) |
### material/stepper
| Commit | Description |
| -- | -- |
| 481f71f33 | fix(material/stepper): strong focus indicator not working for below label position (#22696) |
| ed09a732f | feat(material/stepper): allow for orientation to be changed dynamically (#22139) |
| 6db0fa94d | fix(material/stepper): setting invalid value for visibility (#22254) |
| 6f998527c | fix(material/stepper): don't allow focus inside a hidden element (#21842) |
| cd3d0e946 | fix(material/stepper): last step not being marked as interacted (#17976) |
| 52f39bc16 | feat(material/stepper): allow for content to be rendered lazily (#15817) |
| a3b5fe3b9 | feat(material/stepper): allow focus origin to be optional input in focus method (#20914) |
### material/table
| Commit | Description |
| -- | -- |
| ee5cf49d9 | fix(material/table): Make table data source interface generic (#22673) |
| 0093105b6 | fix(material/table): data source filteredData not updating while disconnected (#22058) |
| 1f1875058 | fix(material/table): increase specificity on sticky selector (#21403) |
| 6d3694251 | fix(material/table): unsubscribe from source when disconnecting (#21338) |
| 3396b4b42 | fix(material/table): rename flex example (#20316) |
### material/tabs
| Commit | Description |
| -- | -- |
| 4f998501a | fix(material/tabs): update tab nav bar focused index on direct focus (#22584) |
| e7a64d371 | fix(material/tabs): projected tabs not being picked up (#21794) |
| 49e60ac62 | fix(material/tabs): coloring issues when a backgroundColor is set (#22612) |
| c12f168fe | fix(material/tabs): stop scrolling on tab change (#22265) |
| f81f67ded | feat(material/tabs): allow for content tabindex to be customized (#21912) |
| 30ea79ae1 | fix(material/tabs): pagination not updating on resize (#22442) |
| d869d79bc | feat(material/tabs): add method for programmatically setting focus (#15228) |
| 16f2a60a7 | fix(material/tabs): strong focus indicator not visible when tab header has a background (#21402) |
| bf0dff8fb | fix(material/tabs): background color inherited to nested groups (#21533) |
| bb44f029e | feat(material/tabs): add test harnesses for tab nav bar (#20822) |
### material/tabs/testing
| Commit | Description |
| -- | -- |
| 05600a217 | feat(material/tabs/testing): polish harness API (#17417) |
### material/testing
| Commit | Description |
| -- | -- |
| 081d833bd | feat(material/testing): expose whether harness elements are focused (#19704) |
### material/theming
| Commit | Description |
| -- | -- |
| 54d4b9356 | fix(material/theming): change to update comments in theming (#21824) |
### material/tooltip
| Commit | Description |
| -- | -- |
| 8d97acff6 | fix(material/tooltip): not updating position after direction changes (#22641) |
| 70ff52878 | fix(material/tooltip): clear pending timers on destroy (#16756) |
| 1a1002797 | feat(material/tooltip): add class to tooltip element based on the current position (#15217) |
| 24cbe1dfb | fix(material/tooltip): handle touch devices in test harness (#21220) |
| ddf99cbba | fix(material/tooltip): not closing when clicking outside using auxiliary button (#21467) |
| eda397c8d | fix(material/tooltip): assign role to aria description element |
| 49927aedd | fix(material/tooltip): not closing when scrolling away using mouse wheel (#19735) |
| d9359c4f5 | fix(material/tooltip): convert message to string (#20685) |
### material/tree
| Commit | Description |
| -- | -- |
| fa7ed4cae | fix(material/tree): not rendering initial data from flat data source (#22340) |
| 483c3e219 | feat(material/tree): add getTreeStructure for tree harness (#20568) |
| 591680011 | feat(material/tree): add test harness for MatTree (#20323) |
| aeb6f8930 | fix(material/tree): Apply aria-level to all nodes (#17818) |
### mdc-button-benchmark
| Commit | Description |
| -- | -- |
| de3222a2e | fix(mdc-button-benchmark): fix unresolved merge conflict (#20221) |
### mdc-chips
| Commit | Description |
| -- | -- |
| 22d7f77e8 | fix(mdc-chips): Set aria-required on input instead of grid (#18049) |
### mdc-form-field
| Commit | Description |
| -- | -- |
| 76c3fb6db | fix(mdc-form-field): refresh notch width when toggling appearances (#18776) |
### mdc-list
| Commit | Description |
| -- | -- |
| c86513618 | feat(mdc-list): add list-option template (#19327) |
### mdc-switch
| Commit | Description |
| -- | -- |
| 5da2ae18c | fix(mdc-switch): updated to latest DOM structure guidance (#17905) |
### menu
| Commit | Description |
| -- | -- |
| ea628c94c | fix(menu): open animation not working on repeat opens (#20382) |
| 1b7ba0bf0 | fix(menu): throw error if menu contains its own trigger (#19943) |
| 5244a9f1f | feat(menu): add input to add overlay pane classes (#19547) |
| 0dbe23bb9 | fix(menu): allow focus to be moved inside menuClosed event (#18756) |
| 3299d8c6f | fix(menu): forward aria attribute to menu panel (#17957) |
| af6c13f24 | fix(menu): internal focus state out of sync if item is focused programmatically (#17762) |
| 017728a3b | fix(menu): keyboard controls not working if all items are disabled inside lazy content (#17407) |
| 987c85dcb | fix(menu): cap maximum elevation for nested menus (#17687) |
| 405f5d02c | fix(menu): trigger should aria-controls panel (#17365) |
| 170299bc1 | feat(menu): move test harness out of experimental (#17113) |
| bfa185305 | fix(menu): restore focus immediately when menu is closed (#16960) |
| d3f63a3b4 | fix(menu): keyboard controls not working if all items are disabled (#16572) |
| d431f2019 | fix(menu): inconsistent behavior when clicking on a disabled item (#16696) |
| 5fb0dc66a | fix(menu): mark lazy menu content as dirty before attach (#16506) |
| 49e8c593f | fix(menu): keyboard controls not respecting DOM order when items are added at a later point (#11720) |
| 58db9db9e | fix(menu): trigger not unsubscribing from panel close stream (#15667) |
| 941a0d941 | fix(menu): prevent menu from collapsing to less than one item (#15454) |
| dfa40fc7f | feat(menu): allow focus restoration to be disabled (#15205) |
| 0185dd1bc | fix(menu): support focus first/last item via home/end keys (#14896) |
| e12687655 | fix(menu): prevent removal of mat-elevation class (#15035) |
| 80f510fa4 | fix(menu): not unsubscribing from close stream if trigger is destroyed (#14107) |
### moment-date-adapter
| Commit | Description |
| -- | -- |
| dd4295608 | feat(moment-date-adapter): implement strict mode (#16462) |
### multiple
| Commit | Description |
| -- | -- |
| fc8a6f9cf | fix(multiple): add inject flags to manual injector calls (#22922) |
| fb1d930d9 | feat(multiple): add ng-update entry for `google-maps` and `youtube-player` package (#22710) |
### ng-add
| Commit | Description |
| -- | -- |
| 822e3e0c2 | fix(ng-add): ng add @angular/material fails in library projects (#19164) |
| b219cbcc6 | fix(ng-add): do not overwrite version range specified in `ng add` (#18365) |
### ng-update
| Commit | Description |
| -- | -- |
| 05ec25f9c | fix(ng-update): properly handle update from different working directory |
| 01e4fbac8 | fix(ng-update): do not throw if project does not have dependencies (#18470) |
| c0c9f4a26 | fix(ng-update): better detection for workspace project in v9 hammer migration (#18525) |
| 411d04824 | fix(ng-update): avoid error if project has folder ending with… (#18454) |
| b53e092b6 | fix(ng-update): do not copy gesture config if only standard HammerJS events are used (#17753) |
| 3acd6c171 | fix(ng-update): imports to `MatProgressSpinnerModule` not migrated (#17717) |
| 4794c6016 | fix(ng-update): hammer v9 migration should not unnecessarily set up gestures (#17713) |
| bfa88fdae | fix(ng-update): migrations not running for release candidate versions (#17704) |
| ec8d4303b | fix(ng-update): material update fails due to circular dependency (#16538) |
| 760058a5c | fix(ng-update): do not rely on node-glob for finding rule directories (#16381) |
| f7ce72146 | fix(ng-update): parse cli workspace config as json5 (#16218) |
| 2adf6294b | fix(ng-update): do not report form-field breaking change from v6 (#16161) |
| a3856c7c9 | fix(ng-update): do not always use double quotes for generated imports (#16131) |
| dc5169154 | fix(ng-update): type imports not migrated to secondary entry-points (#16108) |
### option
| Commit | Description |
| -- | -- |
| 0f569ff40 | fix(option): Remove aria-selected='false' in single-selection mode (#15617) |
### overlay
| Commit | Description |
| -- | -- |
| bbf56706e | fix(overlay): only dispatch position change event if requested (#19785) |
| 4a3c960e6 | fix(overlay): overlay directives not emitting when detached externally (#7950) |
| 7427b2658 | fix(overlay): outside click dispatcher not accounting for shadow DOM (#19904) |
| 210d054f0 | feat(overlay): support closing when clicking outside the overlay (#16611) |
| 7037c3a33 | fix(overlay): resolve circular dependency (#19433) |
| 27a812bb4 | fix(overlay): remove potentially leaky observable (#19146) |
| d321d450c | fix(overlay): expand flexible origin type to allow SVG elements (#19199) |
| 0d7e2f00b | fix(overlay): incorrectly calculating using minWidth and minHeight as a string (#18540) |
| 29eec7729 | fix(overlay): only clear duplicate containers from different platform (#17006) |
| ee96e05e8 | fix(overlay): restore previous host element before attaching (#17855) |
| 9f2c93725 | fix(overlay): don't reset global overlay alignment when width is 100% and there's a maxWidth (#17842) |
| 969d5c25a | fix(overlay): maxWidth and maxHeight not applied when using ex… (#17586) |
| 5509c2347 | fix(overlay): error when trying to add/remove empty string cla… (#14919) |
| a30270e5c | fix(overlay): _updateElementSize should not fail if pane is disposed. (#16600) |
| b98a3bd6c | feat(overlay): allow width/height when using point as flexible origin (#16739) |
| 036729dc1 | fix(overlay): clear duplicate overlay container coming in from the server (#11940) |
| 453b1e8be | fix(overlay): events not being unbound from destroyed backdrop (#16268) |
| f61730a8b | fix(overlay): incorrectly calculating position when page is scrolled horizontally and overlay is anchored to the right (#16235) |
| 2d93c6d7f | fix(overlay): stop using capture phase for overlay keyboard handling (#16019) |
| b1c10d1fe | fix(overlay): allow overlay sass variables to be overwritten (#15507) |
| 00226f0ac | fix(overlay): add panelClass from position to the overlay (#15853) |
| 6e52023fe | fix(overlay): flexible position strategy throwing error for empty strings (#14935) |
| 33081878a | feat(overlay): allow for scroll strategy to be swapped out (#15067) |
| cd72c9dc8 | fix(overlay): unnecessarily pushing overlay if it is exactly as wide as the viewport (#14975) |
| 651549f7a | feat(overlay): allow for connected overlay to be positioned relative to a point (#14616) |
| c92d8c985 | fix(overlay): update size if dimensions change in overlay directives (#14610) |
| 86c530e9b | fix(overlay): reset transform when disposing of position strategy (#14660) |
| 40f8b2039 | fix(overlay): not sizing flexible overlay correctly when opening downwards on a scrollable page (#14672) |
### paginator
| Commit | Description |
| -- | -- |
| c7c6262b1 | feat(paginator): add provider to configure default options (#17595) |
| 5a6cdaf26 | feat(paginator): add test harness (#17969) |
### platform
| Commit | Description |
| -- | -- |
| 656904156 | fix(platform): detect and ignore scrollBehavior polyfills (#20155) |
| 46babbd58 | fix(platform): avoid errors if ShadowRoot is not defined (#19124) |
| 633e4c297 | fix(platform): RTL scrolling behavior detection not using cached value in some cases (#18389) |
### popover-edit
| Commit | Description |
| -- | -- |
| f70f49af7 | fix(popover-edit): hover content not showing up if content changes after init (#18937) |
| 17f8e9419 | fix(popover-edit): unable to close focus content using the keyboard (#18945) |
| b163b644d | feat(popover-edit): Ability to disable edit on specific cells (#18273) |
| 5c9f0d6f2 | fix(popover-edit): Call markForCheck against row hover content when showing (#18258) |
| 5b8c581dc | feat(popover-edit): Adds support for using mat-selection-list for select-like interactions. (#18194) |
| 790b53eba | fix(popover-edit): incorrect spacing for form field inside pop… (#17600) |
| 48cc5144a | fix(popover-edit): prevent default escape action (#16747) |
| 615070acb | fix(popover-edit): unable to close by pressing on enter on some screen readers (#16466) |
| 174bf4076 | fix(popover-edit): focus trap not being destroyed and potential leaks with takeUntil (#16091) |
| 13becdab5 | fix(popover-edit): incorrectly caching values for more than one control (#16057) |
| b5b9ff726 | fix(popover-edit): blending in with background in high contrast mode (#16604) |
| 69b1b2ec9 | fix(popover-edit): remove fallthroughs in switch statement (#16281) |
| 57b990277 | feat(popover-edit): Helper class to reduce form state preservation boilerplate (#15939) |
| 461d5390d | feat(popover-edit): accessible row hover content (#15917) |
| ab76eaa82 | fix(popover-edit): unable to change type of popover buttons (#16058) |
| 558295b78 | fix(popover-edit): rework host listeners to account for changes in Ivy (#16060) |
| 7774ae1e2 | fix(popover-edit): direction not being passed to overlay (#15951) |
| 058ed0f66 | feat(popover-edit): Material version of popover edit (#15873) |
| 414382462 | perf(popover-edit): collect common services into a single class for dependency injection (#15797) |
| d3d026b42 | feat(popover-edit): allow tabbing from popup to next/previous cell (#15793) |
| f6edba3e5 | feat(popover-edit): Arrow keys move focus to neighboring cells (#15762) |
| 1a847704e | feat(popover-edit): Adds support for spanning multiple columns and setting width of the popup based on the size of the cell(s) (#15724) |
| 457ff28d5 | feat(popover-edit): experimental popover edit for tables (mvp) (#15496) |
### portal
| Commit | Description |
| -- | -- |
| a388cc3af | fix(portal): running change detection before nodes have been moved to outlet (#16407) |
| 2e6045cff | fix(portal): better handling when dom portal content can't be restored (#17851) |
| 6d0824088 | fix(portal): content not rendered inside outlet when view container is provided (#17731) |
| d3d885965 | feat(portal): add new portal that projects DOM nodes (#16101) |
| 70bc4d56e | fix(portal): correct return type of TemplatePortal.attach (#14602) |
### progress
| Commit | Description |
| -- | -- |
| 26df0359c | feat(progress): move harnesses out of experimental (#17115) |
### progress-bar
| Commit | Description |
| -- | -- |
| 4699f30f9 | fix(progress-bar): buffer not rendering correctly on ios (#19346) |
| 004eeb821 | fix(progress-bar): changed after checked error on animation end event with noop animations (#18441) |
| a88d05339 | fix(progress-bar): clear aria-valuenow in indeterminate or query mode (#15019) |
### progress-spinner
| Commit | Description |
| -- | -- |
| 930bc7e92 | fix(progress-spinner): rotating circle changing surrounding layout (#16930) |
| abc94c4de | fix(progress-spinner): not respecting user colors in high contrast mode (#19786) |
| dadb3e1c8 | fix(progress-spinner): animation node inserted into wrong style root when using ngIf with ShadowDom encapsulation (#16982) |
| c11653334 | fix(progress-spinner): non-default diameter indeterminate animation not working inside Shadow DOM (#16177) |
| dd4257eac | fix(progress-spinner): clear aria-valuenow in indeterminate mode (#15052) |
### progress-spinner/testing
| Commit | Description |
| -- | -- |
| 3ffcc632d | fix(progress-spinner/testing): harness selector not matching mat-spinner selector (#19657) |
### propover-edit
| Commit | Description |
| -- | -- |
| 5bf0487ef | fix(propover-edit): incorrect template root note retrieved in ivy |
### radio
| Commit | Description |
| -- | -- |
| 2c83b404b | fix(radio): take default tabindex value from attribute (#20453) |
| fe298350c | fix(radio): clicks not landing correctly in some cases on Chrome (#18357) |
| 8c51ddabe | fix(radio): Move .mat-radio-input above .mat-focus-indicator. (#18709) |
| ef439b409 | feat(radio): move test harness out of experimental (#17117) |
| 237e030c8 | fix(radio): clear aria attributes from host node (#16938) |
| f2cbadedb | fix(radio): show ripple on programmatic focus (#16512) |
| 5c51301b4 | feat(radio): add provider for default color input (#15811) |
| 6c03e2f5f | feat(radio): support theme color on mat-radio-group (#15741) |
| 2f616072e | fix(radio): ng-touched incorrectly being set on click (#12560) |
| 76c2a3cea | fix(radio): only show focus ripple for keyboard focus (#13565) |
| ce632b04d | fix(radio): unable to distinguish disabled radio button in high contrast mode (#15375) |
| 677db8cfc | fix(radio): underlying label not expanding to width of radio button (#14895) |
| 58460380f | fix(radio): unable to click to select button if text is marked (#14967) |
| d72eb467c | fix(radio): not updating DOM node name if group name changes (#14950) |
### radio-button
| Commit | Description |
| -- | -- |
| bd3bf09ab | fix(radio-button): underlying input not respecting value binding |
### radio/checkbox
| Commit | Description |
| -- | -- |
| 5fd431fe4 | feat(radio/checkbox): show background-color in print stylesheet (#22298) (#22299) |
### ripple
| Commit | Description |
| -- | -- |
| 9a16e6098 | perf(ripple): optimize event registration (#18633) |
| 79330b7fb | perf(ripple): avoid page layouts from ripple elements (#17253) |
### ripples
| Commit | Description |
| -- | -- |
| 4f755cf10 | feat(ripples): support updating global ripple options at runtime (#14705) |
### schematics
| Commit | Description |
| -- | -- |
| 290d102a5 | fix(schematics): global typography class always being added (#18315) |
| e02bb8252 | fix(schematics): do not depend on external dependency for colors (#17788) |
| c08050d19 | feat(schematics): add prompt to add global typography class (#17602) |
| 5e108336f | fix(schematics): secondary entry point migration not working against v9 (#17452) |
| 6275b49ae | fix(schematics): module imports not generated for schematics (#16787) |
| 3205b3188 | fix(schematics): navigation schematic not respecting breakpoints on initial render (#16788) |
| 43a01e99c | feat(schematics): add font-display query (#16363) |
| 6c7fd3011 | fix(schematics): avoid lint warning in code generated by nav schematic (#16088) |
| 7b603c569 | fix(schematics): use ngAfterViewInit instead of ngOnInit in table (#15446) |
| fe6629a51 | fix(schematics): ensure project "style" and "skipTests" options are respected (#15513) |
| d0cd9c09d | fix(schematics): do not run migrations multiple times (#15424) |
| da8987b6f | fix(schematics): incorrectly throws if NgModule uses namespaced decorator (#15298) |
| f2cb83725 | fix(schematics): do not generate invalid stylesheet files (#15235) |
### scrolling
| Commit | Description |
| -- | -- |
| a62a50afb | fix(scrolling): virtual scroll not accounting for margin when measuring range (#19852) |
| ea9293d21 | fix(scrolling): viewport ruler events being run inside zone (#15814) |
| c36466c2f | fix(scrolling): update virtual scroll viewport size on resize (#18058) |
| 8daaf4d4b | fix(scrolling): virtual scroll throw off if directive injects ViewContainerRef (#16137) |
| 8494f0321 | fix(scrolling): virtual scroll not disconnecting from data source on destroy (#15856) |
| 4ff1c95ae | fix(scrolling): virtual scroll viewport error during server-side rendering (#15299) |
### select
| Commit | Description |
| -- | -- |
| 07faecc93 | fix(select): not marking options as selected correctly when setting value with duplicates (#13361) |
| 6fbf142ac | fix(select): use combobox pattern for accessibility (#20082) |
| 77b11f47c | fix(select): emitting change event twice for reset values (#13598) |
| 316141ff0 | fix(select): indicating programmatic value change as user interaction in some cases (#19970) |
| 4e6083b6e | fix(select): don't select active item when tabbing away while closed (#18797) |
| dbdc1a8c5 | feat(select): add injection token for configuring default opti… (#17543) |
| 2f1745083 | fix(select): don't handle open key presses while the user is typing (#17785) |
| 93fdb00b9 | fix(select): select active item when tabbing away (#17592) |
| d773cce08 | fix(select): not picking up indirect descendant option groups (#17458) |
| d453d0662 | fix(select): highlighted option not updated if value is reset while closed (#17213) |
| f23a56a90 | feat(select): allow for typeahead debounce interval to be customized (#16579) |
| 28743f1bb | fix(select): add duration to live announcer message (#15655) |
| f6cd86e8d | fix(select): optionSelectionChanges not emitting when the list of options changes (#14814) |
| bc6b5fb3c | fix(select): Fixes width-issue of select option panel in IE (#11801) |
| a115b3a0d | fix(select): error when navigating via keyboard to reset option on a closed select (#15160) |
| 78f55eaf6 | fix(select): update panel width if the viewport size changes (#14932) |
### select,input,form-field
| Commit | Description |
| -- | -- |
| 1c1af58ce | feat(select,input,form-field): move test harnesses out of expe… (#17874) |
### select/testing
| Commit | Description |
| -- | -- |
| e46afe81e | fix(select/testing): incorrect options if multiple selects are on the page at the same time (#19112) |
### selection-list
| Commit | Description |
| -- | -- |
| ff0de1187 | fix(selection-list): incorrectly handling A key in some cases (#18513) |
| 66d38fc59 | feat(selection-list): support specifying theme color (#15237) |
### sidenav
| Commit | Description |
| -- | -- |
| 27e3b9dbb | fix(sidenav): run autosize debounce timer outside the NgZone (#18898) |
| 5ed1a0034 | fix(sidenav): restore focus if drawer is closed through backdrop click (#19534) |
| 99d3e1289 | fix(sidenav): not restoring focus to SVG elements (#18614) |
| c9856eeb5 | fix(sidenav): move focus into sidenav in side mode if autoFocu… (#17995) |
| 39c007413 | fix(sidenav): not destroying custom QueryList (#17619) |
| 993347977 | fix(sidenav): container not picking up indirect descendant sid… (#17453) |
| aa2e0abf6 | feat(sidenav): move harnesses out of experimental (#17122) |
| 197091cf1 | fix(sidenav): focus trap enabled state not updated if mode changes while open (#16602) |
| 1de1b9823 | fix(sidenav): avoid CSS class name conflict (#16798) |
| ab5e3c8d3 | fix(sidenav): some internal subjects not being completed (#15567) |
### slide-toggle
| Commit | Description |
| -- | -- |
| 99b27e805 | fix(slide-toggle): clicks not landing correctly in some cases on Chrome (#18285) |
| 2fd862d68 | fix(slide-toggle): fix and simplify high contrast styles (#18104) |
| 15ba87167 | feat(slide-toggle): move harness out of experimental (#17132) |
| fb390fbc8 | fix(slide-toggle): clear static aria attributes from host nodes (#17085) |
| 534b9c24c | feat(slide-toggle): remove Hammer.js dependency (#17102) |
| a415b52ea | fix(slide-toggle): invalid required validator in template-driven forms (#16547) |
| 917a52e03 | fix(slide-toggle): focus ripple not hiding after click/touch (#13562) |
| e8827e2b8 | fix(slide-toggle): able to receive focus while disabled on click (#15501) |
| 48d17afc1 | fix(slide-toggle): thumb animation not working on mobile (#15236) |
| 01dcf7ee7 | fix(slide-toggle): input element should use switch role (#15073) |
| 7d96ed3e2 | fix(slide-toggle): use default hue for thumb in dark theme (#14230) |
### slider
| Commit | Description |
| -- | -- |
| ce723693d | fix(slider): don't emit change events on mousedown (#20240) |
| 2a6a63ceb | fix(slider): focus ring not matching theme color (#19519) |
| 1718d7883 | fix(slider): not stopping drag when released outside of viewport (#18905) |
| 3b3c2ca73 | fix(slider): stop dragging if page loses focus (#17849) |
| 320f38749 | fix(slider): handle touchcancel event (#17520) |
| 584ad3fc7 | fix(slider): some potentially broken styles when using css var… (#17580) |
| fa18ce172 | fix(slider): track fill not rendering on ios safari when slide… (#17583) |
| 00a3e79ae | feat(slider): remove Hammer.js dependency (#16860) |
| 8229353f6 | feat(slider): move harness out of experimental (#17136) |
| 17c89830d | fix(slider): displayWith function never called with "null" (#16707) |
| 7039b25f1 | fix(slider): inconsistent cursor behavior if user's pointer moves around while dragging |
| 07433fdf5 | fix(slider): focus ring showing when ancestor has focus monitoring (#14960) |
### snack-bar
| Commit | Description |
| -- | -- |
| 1bbfcf409 | fix(snack-bar): announcing same message twice to screen readers (#14504) |
| 86a8fee73 | fix(snack-bar): handle large numbers passed in as duration (#17239) |
| 8d1290238 | fix(snack-bar): don't stretch to fullscreen in landscape orientation (#16940) |
| e9baa09be | fix(snack-bar): too tall under some circumstances in Safari (#16679) |
### sort
| Commit | Description |
| -- | -- |
| ea22e92a6 | fix(sort): sorted state being read out when navigating cells |
| 191357ad5 | fix(sort): no focus indication for active header (#17735) |
| 81294f7dc | feat(sort): add test harness (#17802) |
| 7594ca121 | feat(sort): remove hammer dependency (#16951) |
| 9d60a5da4 | fix(sort): remove arrow when sort header is disabled (#15212) |
| 027d4f4b4 | fix(sort): extra Firefox focus outline not being reset (#14733) |
### stepper
| Commit | Description |
| -- | -- |
| e545b561f | feat(stepper): add theming support (#20424) |
| f343dedb1 | feat(stepper): add test harness (#20092) |
| 9d309f7dd | fix(stepper): parent stepper picking up steps from child stepper (#18458) |
| df7156e06 | fix(stepper): remove tabindex from content (#16809) |
| cd7d8c86b | fix(stepper): not rendering correctly in some cases when step… (#17555) |
| 5f0f2dc54 | fix(stepper): not picking up indirect descendant elements (#17529) |
| bebb9ff78 | fix(stepper): unable to skip step if completed value is overwritten (#15403) |
| 8b5c0f12c | fix(stepper): Fix visual flake in focusing stepper header (#15870) |
| 876727dbf | fix(stepper): content not being rendered out initially with ivy (#15485) |
| a14649960 | fix(stepper): avoid breaking change in stepControl type (#15464) |
| 9a771648f | fix(stepper): unable to tab to step content (#14892) |
| a6cc98fa6 | feat(stepper): allow disabling ripples of headers (#14972) |
| e7b0e40bf | fix(stepper): ensure step state is not minified (#14933) |
### style
| Commit | Description |
| -- | -- |
| 15038e389 | feat(style): allow palettes to specify a separate hue for colored text (#15149) |
### table
| Commit | Description |
| -- | -- |
| ab19ecca1 | feat(table): expand cell harness api (#21162) |
| 6ec155157 | fix(table): filter predicate not called for falsy values (#19094) |
| 21f2df349 | fix(table): correctly sort columns with mixed data types |
| 1f6b90c0a | fix(table): incorrect padding for single-cell rows in rtl (#20266) |
| 1b1c31e91 | perf(table): Slightly improve speed of adding/remvoing sticky styles (#19823) |
| bf953e936 | perf(table): Do column name string interpolation once per column instead of once per cell (#19801) |
| f484e964d | perf(table): Reduce calls to updateStickyColumnStyles (#19739) |
| b3099c839 | fix(table): no data row not shown if data source is empty on init (#19994) |
| 95007e585 | fix(table): incorrectly sticking multiple footer rows (#19321) |
| e512581a8 | feat(table): add the ability to show a data row when no data is available (#18041) |
| 32aec936b | fix(table): error when nesting tables (#18832) |
| a30094b47 | feat(table): add test harness (#17799) |
| 6982054f6 | fix(table): not picking up indirect descendant defs (#17340) |
| 254fb49b1 | fix(table): better error message if text column is missing a name |
| 5259f22e7 | fix(table): error in Ivy for coerced multiTemplateDataRows (#16047) |
| 301371aad | fix(table): schematic generates code that throws an exception (#15800) |
| e774692ba | fix(table): text-column throws if name input is set eagerly with ivy |
| cf767074a | feat(table): add text column for simple columns (#14841) |
| d525f9c39 | fix(table): use static queries for examples (#15483) |
| f82259bac | fix(table): use default change detection strategy on table (#15440) |
| 0db904418 | fix(table): add missing rowgroup roles (#15131) |
| e136fc870 | fix(table): Clarify unknown table column error (#14947) |
| cfe46dff3 | fix(table): allow for a caption to be projected (#14965) |
| a31a2ff38 | fix(table): not re-rendering when switching to a smaller set of data than the current page (#14665) |
### table/testing
| Commit | Description |
| -- | -- |
| e45e4528d | feat(table/testing): allow filtering by column name (#19224) |
### tabs
| Commit | Description |
| -- | -- |
| 24d20fb30 | fix(tabs): mark tab body as a scrollable container (#16344) |
| ef18b7564 | fix(tabs): focusChange not being emitted when tabbing into a tab header (#15094) |
| d6e6f44c1 | feat(tabs): allow for dynamicHeight to be configured through MAT_TABS_CONFIG (#19677) |
| 0ee25a2a4 | fix(tabs): some bugs with docs and coercion (#20356) |
| a0b44d4b6 | fix(tabs): always defaulting focusIndex to 0 on initialization (#20384) |
| b38c812da | fix(tabs): don't prevent default space/enter action if action tab doesn't change (#19207) |
| 6a64130b6 | fix(tabs): unnecessarily adding pagination when changing to new list of tabs with same labels (#16869) |
| 5224ac21f | fix(tabs): group alignment propagating to nested groups (#19037) |
| 973ee828a | fix(tabs): tab nav bar not disabling pagination animation (#18886) |
| bd62f98ad | fix(tabs): don't start auto-scroll when right clicking on buttons (#18033) |
| 1a53f036f | fix(tabs): better high contrast indication on supported browsers (#18160) |
| b7b7bd05a | fix(tabs): custom QueryList not being cleaned up (#17548) |
| bb9a3a84b | feat(tabs): add input to opt out of pagination (#17409) |
| ed0067ec8 | fix(tabs): not picking up indirect descendant tabs in ivy (#17346) |
| 35b32260d | fix(tabs): no longer use OnPush (#16529) |
| ef5d9cbf2 | fix(tabs): avoid Ivy template type checking errors in tab link (#17282) |
| 8c9801398 | fix(tabs): avoid template type checking errors with Ivy (#17228) |
| a2ccacd16 | feat(tabs): move harnesses out of experimental (#17137) |
| 93e941521 | fix(tabs): tab nav bar not highlighting active tab if rendered after init (#16624) |
| 9aa326e14 | fix(tabs): only use aria-current on active links (#16562) |
| aa2236820 | feat(tabs): support pagination in nav bar (#16055) |
| 27a08cc60 | fix(tabs): disable all animations when using NoopAnimationsModule (#11395) |
| e66131744 | feat(tabs): add automatic scrolling when holding down paginator (#14632) |
| 76cb9d09a | fix(tabs): don't handle keyboard events with modifier keys (#14234) |
| 220e6b2a3 | fix(tabs): pagination not working correctly on chrome in rtl mode (#14690) |
| 6f4981380 | fix(tabs): better handling of animationDuration without units (#14778) |
### text-field
| Commit | Description |
| -- | -- |
| a586f02da | fix(text-field): unable to undo/redo in autosized text field on firefox (#19238) |
| a3e953ee7 | fix(text-field): correctly check _initialHeight (#17900) |
### toolbar
| Commit | Description |
| -- | -- |
| 646d47fd5 | fix(toolbar): not picking up indirect descendant rows (#17469) |
### toolbar/testing
| Commit | Description |
| -- | -- |
| 9e97a34cf | feat(toolbar/testing): Add a test harness for `MatToolbar` (#19976) |
### tooltip
| Commit | Description |
| -- | -- |
| 04b75239b | perf(tooltip): Hook up to pointer leave events when pointer enter events fire (#19777) |
| 49de56ca9 | perf(tooltip): Defer hooking up events until there's a message and the tooltip is not disabled (#19764) |
| 924494d8f | fix(tooltip): theming can affect the tooltip color (#17643) |
| 493c32dc4 | perf(tooltip): avoid triggering change detection for all keydown events (#17331) |
| 412602970 | feat(tooltip): remove Hammer.js dependency (#17003) |
| 1006cc2d0 | fix(tooltip): avoid adding same aria description as trigger's aria-label (#16870) |
| 76c6fa559 | fix(tooltip): tooltip sample not working with keyboard navigation. (#15111) |
| 59818d12e | fix(tooltip): render style values in ngOnInit instead of the constructor (#15469) |
| 342e6f0ad | feat(tooltip): allow for default position to be configured (#14872) |
| 0394d59bb | fix(tooltip): afterHidden stream not being completed (#14620) |
### tooltip/testing
| Commit | Description |
| -- | -- |
| 44accd652 | feat(tooltip/testing): add test harness for mat-tooltip (#19144) |
### tree
| Commit | Description |
| -- | -- |
| 8ea3558fa | fix(tree): allow use of FlatTreeControl's trackBy function in MatTreeFlatDataSource and MatTreeFlattener (#19600) |
| 403a3d1ca | fix(tree): complete viewChange stream on destroy (#18991) |
| c5923d6ac | fix(tree): not allowing horizontal overflow (#18215) |
| 52918ea8f | fix(tree): fix typo in CSS class name (#17538) |
| 7f1c2cab2 | fix(tree): not picking up indirect descendant node definitions (#17522) |
| 3bd160b7e | fix(tree): unable to set zero as the padding of a tree node (#16345) |
| 3ddcd8df2 | fix(tree): opposite direction padding not being reset on change (#14816) |
### tree,scrolling
| Commit | Description |
| -- | -- |
| 0ab81138c | fix(tree,scrolling): don't require user DataSource to extend DataSource (#14966) |
### typography
| Commit | Description |
| -- | -- |
| f95af1a84 | fix(typography): default to normal letter spacing |
| d9977bdb1 | fix(typography): use `calc` to allow css variables (#16475) |
| 06735742f | fix(typography): move header letter spacing into typography config (#15210) |
### virtual-scroll
| Commit | Description |
| -- | -- |
| 2470a4249 | fix(virtual-scroll): move views that are already attached instead of inserting (#15348) |
## Breaking Changes
### material
...
Components can no longer be imported through "@angular/material". Use the individual secondary entry-points.
### 
...
Reference: TOOL-836
MatPaginatorIntl will now cause MatPaginator to display
an 'EN DASH' (U+2013) rather than a 'HYPHEN-MINUS' (U+002D)
### cdk/accordion
The `disabled` and `expanded` properties in the `AccordionItem` are now strict to `boolean`.
### checkbox
MAT_CHECKBOX_CLICK_ACTION is deprecated, use MAT_CHECKBOX_DEFAULT_OPTIONS
### material/snack-bar
matSnackBarHarness.getRole() replaced with .getAriaLive() due to using aria-live
rather than the alert and status roles.
### overlay
OverlayKeyboardDispatcher (used in dialog and overlay
...
### material/dialog
`MatDialogClose#dialogRef` class member to become private.
## Special Thanks:
Abderrahmane Hamila, Adam, Adam Kocsis, Adrien Crivelli, Ajit Singh, Akshay Verma, Alan Agius, Alberto Aldegheri, Aleksandar Kamenov, Alex Langdon, Alex Rickabaugh, AlexElin, Alexander M, Alexey Makhrov, Alexey Zuev, Allan G, Alvaro Junqueira, Amadou Sall, Amit Gharat, Amy Sorto, Anders Kjær Damgaard, Andi Qu, Andres Roget, Andrew, Andrew Flower, Andrew Scott, Andrew Seguin, Andrius, Andy Chrzaszcz, Annie Wang, Anthony Drogon, Antoine Boisier-Michaud, Antonio Cardenas, Antonio Stipić, ArcaneAj, Ariel Lee, Aristeidis Bampakos, Artur Araslanov, Athur Ming, Babis K, Ben Elliott, Benjamin Kindle, Billy Lando, Bjorn S, Bowen Ni, Bram Gotink, Bram Peirs, Bruno Kilian, ByzantineFailure, CaerusKaru, Cassandra Choi, Chris Bubernak, Christian Jensen, Craig Spence, Cyrille Tuzi, Daniel Brown, Daniele Maltese, Dario Braun, David Lasry, David Lozano Jarque, David Purpura, Dirk Luijk, Dmitriy Stepanenko, Dominik, Dominik Rabij, Drummond Dawson, Duncan, Emanuel Hein, Emma Twersky, Eran Shmil, Eric NICOLAS, Erik Welander, Escher Wenberg, Esteban Gehring, Esteban Marin, Felipe Norato Lacerda, Filip Lauc, Filipe Silva, George Kalpakas, Gilliam, Giora Guttsait, Gobius Dolhain, Greg Magolan, Guillaume de Jabrun, Gérôme Grignon, Howard, Hsuan Lee, Hugo Estévez Rocha, Igor Minar, Isitar, Ivan Stanevich, J Z, J. G. Sebring, James Vickery, James Wright, Jan Malchert, Jean de Klerk, Jeremy Elbourn, Jeremy Mowery, Jeremy Thompson, Jeroen Zwartepoorte, Jerome Nelson, Jesse Palmer, Jessica Xu, Joakim Zebic, Joep Kockelkorn, Joey Perrott, John Crowson, John S, Joost Huizinga, Joost Koehoorn, Kara, Kara Erickson, Karl Seamon, Kavi Jivan, Kern Zhao, Kevin Drouvin, Kirankumar Sripati, Klemen Oslaj, Kristiyan Kostadinov, Kyle J. Kemp, Kyle Owsen, Lars Gyrup Brink Nielsen, Lazar Ljubenović, Livvie Lin, Liz Mitchell, Luka Onikadze, Lukas Spirig, Lukas Taake, Lukáš Matta, Malte, Marc Laval, Marc-André Daigneault, Marco Marche, Mark Hansen, Martin Kamenov, Martin Probst, Mathias Paumgarten, Matias Niemelä, Matteo Vesprini-Heidrich, Matthew Leffler, Matthias Kunnen, Max, Md. Enzam Hossain, Meet Shah, Mendy Berger, Michael Hoffmann, Michael Leibman, Michael Prentice, Michael-James, Michał Koziara, Miguel Galante, Miles Malerba, Milko Venkov, Mitchell Skaggs, Mitchell Wills, Mouad Ennaciri, Nathan Clarke, Nathan Tate, Nick Walther, Nicolas Villanueva, Nigel, Nikhil Walvekar, Nikita Poltoratsky, Nitin Malave, Niyaz, Noriyuki Shinpuku, NothingEverHappens, Olegas Goncarovas, Oleksii Potiekhin, Olivier Suritz, Orlando Pozo, POFerro, Panagiotis Bochalis, Pankaj Parkar, Paul Féraud, Paul Gschwendtner, Pavel Agarkov, Pavithran Gridharan, Pawel Kozlowski, Piotr Błażejewicz (Peter Blazejewicz), Pit, RN Lee, Rado Kirov, Rafael Santana, Rafał Sławik, Raz Luvaton, Robert Coie, Ron Lapushner, Roy, Rudar Daman Singla, Rudolf Olah, Sachin Grover, Santosh Yadav, Sascha, Saurabh Kamble, Scott Wang, Sergey Koshechkin, Sloan Haywood, Sriram Jayarman, Stefan Aleksovski, Steven Xu, Suguru Inatomi, Suresh918, Takuma Kira, Ted Janeczko, Terence Honles, Thomas, Tim Deschryver, Tim Paschedag, Tim Sawyer, Tobias Schneider, Tobias Schweizer, Trevor Karjanis, Trong Nguyen, Vanessa Schmitt, Victor, Vikash Dahiya, Viktor Slavov, Vinit Tomar, Vitaliy Bobrov, Wagner Maciel, Walter S, Wayou Liu, Wenqi, Wildhammer, Will Howell, William Lohan, Xiangyun Chi, Yifan Ge, Younes Jaaidi, Yuriy Babyak, Zack Elliot, Zack Elliott, adhispace, ahong11, alexanderPastornicky, bpetex, chunghha, crisbeto, cronventis, cynthialong0-0, dbosh88, dependabot[bot], felhag, fhuschle, jchw, jeripeierSBB, jnavb, jysoo, kor-k, manughub, manzonif, marvinderksen, mbehrlich, mcalmus, mertdeg2, mmalerba, nielsr98, s4m0r4m4, shawn-avrio, swseverance, timonkrebs, tomrlq, trik, ukrukarg, visurel, vivian-hu, why520crazy, willbeaufoy, xkxx, zelliott, Álvaro Martínez and ɯλrv
